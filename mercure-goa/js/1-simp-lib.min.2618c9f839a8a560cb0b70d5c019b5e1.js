...
!(function (e, t) {
        ...
        for (
          ...
          if (null != (i = arguments[s]))
            for (r in i)
              (e = a[r]),
                a !== (n = i[r]) &&
                  (l && n && (E.isPlainObject(n) || (t = E.isArray(n)))
                    ? (t
                        ? ((t = !1), (o = e && E.isArray(e) ? e : []))
                        : (o = e && E.isPlainObject(e) ? e : {}),
                      (a[r] = E.extend(l, o, n)))
                    : void 0 !== n && (a[r] = n));
        return a;
      }),
  ...
  var p = (function (n) {
    ...
    try {
      q.apply((t = M.call(x.childNodes)), x.childNodes),
      ...
      return (
        ...
        ae(function (e, t, n, r) {
          var i,
            ...
            d = m ? (v || (e ? p : l || g) ? [] : t) : f;
          if ((m && m(f, d, n, r), g))
            for (i = ye(d, u), g(i, [], n, r), o = i.length; o--; )
              (a = i[o]) && (d[u[o]] = !(f[u[o]] = a));
          if (e) {
            if (v || p) {
              if (v) {
    ...
    function be(e) {
      for (
        ...
        if ((t = b.relative[e[s].type])) c = [ge(ve(c), t)];
        else {
  ...
  (E.filter = function (e, t, n) {
    ...
    E.fn.extend({
      find: function (e) {
        ...
        return (
          ((n = this.pushStack(1 < i ? E.unique(n) : n)).selector = this
            .selector
            ? this.selector + " " + e
            : e),
          n
      ...
      is: function (e) {
        return !!N(this, "string" == typeof e && b.test(e) ? E(e) : e || [], !1)
          .length;
      },
    });
  var k,
    ...
    if (((n = n || k), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          E.merge(
            this,
            E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : h, !0)
          ),
  ...
  E.fn.extend({
    has: function (e) {
      ...
      return this.filter(function () {
        for (t = 0; t < r; t++) if (E.contains(this, n[t])) return !0;
      });
    },
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = b.test(e) || "string" != typeof e ? E(e, t || this.context) : 0;
        r < i;
        r++
      )
      ...
      function (r, i) {
        E.fn[r] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (D[r] || (n = E.uniqueSort(n)), A.test(r) && (n = n.reverse())),
            this.pushStack(n)
          );
        };
      }
  ...
  function M() {
    h.addEventListener
      ...
      : (h.detachEvent("onreadystatechange", _), C.detachEvent("onload", _));
  }
  function _() {
    (h.addEventListener ||
      "load" === C.event.type ||
  ...
  (v.ownFirst = "0" === H),
    ...
    E(function () {
      ...
      (n = h.getElementsByTagName("body")[0]) &&
        ...
        ((r = h.createElement("div")).style.cssText =
  ...
  function I(e, t, n, r) {
    if (O(e)) {
      ...
      if (
        ...
        return (
          l || (l = s ? (e[a] = f.pop() || E.guid++) : a),
          u[l] || (u[l] = s ? {} : { toJSON: E.noop }),
          ("object" != typeof t && "function" != typeof t) ||
            (r
              ? (u[l] = E.extend(u[l], t))
              : (u[l].data = E.extend(u[l].data, t))),
          (o = u[l]),
          r || (o.data || (o.data = {}), (o = o.data)),
          void 0 !== n && (o[E.camelCase(t)] = n),
          "string" == typeof t
            ? null == (i = o[t]) && (i = o[E.camelCase(t)])
            : (i = o),
          i
        );
    }
    ...
    E.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = E.data(o)), 1 === o.nodeType && !E._data(o, "parsedAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                0 === (r = a[n].name).indexOf("data-") &&
                B(o, (r = E.camelCase(r.slice(5))), i[r]);
  ...
  function fe(e, t, n, r, i) {
    for (
      var o, a, s, u, l, c, f, d = e.length, p = ie(t), h = [], m = 0;
      m < d;
      m++
    )
      if ((a = e[m]) || 0 === a)
        if ("object" === E.type(a)) E.merge(h, a.nodeType ? [a] : a);
          ...
          if (
            ...
            for (
              ...
              E.nodeName((c = a.childNodes[o]), "tbody") &&
                !c.childNodes.length &&
                a.removeChild(c);
          for (E.merge(h, u.childNodes), u.textContent = ""; u.firstChild; )
    ...
    for (
      ...
      if (r && -1 < E.inArray(a, r)) i && i.push(a);
        ...
        ((s = E.contains(a.ownerDocument, a)),
  ...
  (E.event = {
        ...
        for (
          n.handler && ((n = (u = n).handler), (i = u.selector)),
            ...
            (c = g.handle) ||
              ((c = g.handle =
                function (e) {
                  return void 0 === E || (e && E.event.triggered === e.type)
                    ? void 0
                    : E.event.dispatch.apply(c.elem, arguments);
                }).elem = e),
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (g && (c = g.events)) {
        ...
        E.isEmptyObject(c) && (delete g.handle, E._removeData(e, "events"));
      }
    },
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !u.noBubble && !E.isWindow(n)) {
          for (
            s = u.delegateType || d, me.test(s + d) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            f.push(a), (l = a);
          l === (n.ownerDocument || h) &&
            f.push(l.defaultView || l.parentWindow || C);
        }
        for (c = 0; (a = f[c++]) && !e.isPropagationStopped(); )
          (e.type = 1 < c ? s : u.bindType || d),
            (i =
              (E._data(a, "events") || {})[e.type] && E._data(a, "handle")) &&
              i.apply(a, t),
            (i = o && a[o]) &&
              i.apply &&
              O(a) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = E.event.handlers.call(this, e, u), t = 0;
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            he.test(i) ? this.mouseHooks : pe.test(i) ? this.keyHooks : {}),
    ...
    (E.removeEvent = h.removeEventListener
      ? function (e, t, n) {
      ...
      (E.event.special.submit = {
        setup: function () {
          ...
          E.event.add(this, "click._submit keypress._submit", function (e) {
            var t = e.target,
              n =
                E.nodeName(t, "input") || E.nodeName(t, "button")
                  ? E.prop(t, "form")
                  : void 0;
            n &&
              !E._data(n, "submit") &&
        ...
        postDispatch: function (e) {
          e._submitBubble &&
            ...
            this.parentNode &&
              !e.isTrigger &&
              E.event.simulate("submit", this.parentNode, e));
        },
        teardown: function () {
          if (E.nodeName(this, "form")) return !1;
      ...
      (E.event.special.change = {
        setup: function () {
          ...
          E.event.add(this, "beforeactivate._change", function (e) {
            ...
            de.test(t.nodeName) &&
              !E._data(t, "change") &&
              (E.event.add(t, "change._change", function (e) {
                !this.parentNode ||
                  e.isSimulated ||
                  e.isTrigger ||
                  E.event.simulate("change", this.parentNode, e);
              }),
              E._data(t, "change", !0));
          });
        },
      ...
      E.each({ focus: "focusin", blur: "focusout" }, function (n, r) {
        ...
        E.event.special[r] = {
          ...
          teardown: function () {
            ...
            t
              ? E._data(e, r, t)
              : (e.removeEventListener(n, i, !0), E._removeData(e, r));
          },
        };
      }),
    E.fn.extend({
  ...
  function Me(n, r, i, o) {
    ...
    if (
      f &&
      ((e = (l = fe(r, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === l.childNodes.length && (l = e),
      e || o)
    ) {
      for (a = (s = E.map(ae(l, "script"), Le)).length; c < f; c++)
        (t = l),
          c !== d &&
            ((t = E.clone(t, !0, !0)), a && E.merge(s, ae(t, "script"))),
          i.call(n[c], t, c);
      if (a)
        for (u = s[s.length - 1].ownerDocument, E.map(s, je), c = 0; c < a; c++)
          (t = s[c]),
            te.test(t.type || "") &&
              !E._data(t, "globalEval") &&
              E.contains(u, t) &&
              (t.src
                ? E._evalUrl && E._evalUrl(t.src)
                : E.globalEval(
  ...
  function _e(e, t, n) {
    for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || E.cleanData(ae(r)),
        r.parentNode &&
          (n && E.contains(r.ownerDocument, r) && se(ae(r, "script")),
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        (v.html5Clone || E.isXMLDoc(e) || !Te.test("<" + e.nodeName + ">")
          ? (o = e.cloneNode(!0))
      ...
      return (
        0 < (r = ae(o, "script")).length && se(r, !u && ae(e, "script")),
        (r = s = i = null),
        o
      );
    },
      ...
      replaceWith: function () {
        ...
        return Me(
          ...
          function (e) {
            ...
            E.inArray(this, n) < 0 &&
              (E.cleanData(ae(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
    ...
    return (
      n ||
        (("none" !== (n = Re(e, t)) && n) ||
          ((t = (
            (Fe = (
              Fe || E("<iframe frameborder='0' width='0' height='0'/>")
  ...
  !(function () {
    ...
    function e() {
      ...
      n.appendChild(l),
        ...
        C.getComputedStyle &&
          ...
          (i = "4px" === (t || { marginRight: "4px" }).marginRight),
    ...
    c.style &&
      ...
      ((l = h.createElement("div")).style.cssText =
  ...
  function rt(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ((o[a] = E._data(r, "olddisplay")),
        (n = r.style.display),
        t
          ? (o[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              V(r) &&
              (o[a] = E._data(r, "olddisplay", Pe(r.nodeName))))
          : ((i = V(r)),
            ((n && "none" !== n) || !i) &&
              E._data(r, "olddisplay", i ? n : E.css(r, "display"))));
    for (a = 0; a < s; a++)
      (r = e[a]).style &&
  ...
  function ot(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += E.css(e, n + U[o], !0, i)),
        r
          ? ("content" === n && (a -= E.css(e, "padding" + U[o], !0, i)),
            "margin" !== n && (a -= E.css(e, "border" + U[o] + "Width", !0, i)))
          : ((a += E.css(e, "padding" + U[o], !0, i)),
            "padding" !== n &&
              (a += E.css(e, "border" + U[o] + "Width", !0, i)));
    return a;
  }
  function at(e, t, n) {
    var r = !0,
  ...
  E.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = e.style;
        if (
          ((t = E.cssProps[s] || (E.cssProps[s] = nt(s) || s)),
    ...
    E.each(["height", "width"], function (e, i) {
      E.cssHooks[i] = {
        get: function (e, t, n) {
          if (t)
            return Ge.test(E.css(e, "display")) && 0 === e.offsetWidth
              ? Ie(e, Ke, function () {
                  return at(e, i, n);
                })
              : at(e, i, n);
          ...
          return it(
            ...
            n
              ? ot(
                  ...
                  i,
                  n,
                  v.boxSizing && "border-box" === E.css(e, "boxSizing", !1, r),
                  r
                )
              : 0
          );
  ...
  function bt(o, e, t) {
    ...
    for (
      ...
      if ((n = bt.prefilters[r].call(l, o, c, l.opts)))
        return (
          E.isFunction(n.stop) &&
            (E._queueHooks(l.elem, l.opts.queue).stop = E.proxy(n.stop, n)),
          n
        );
    return (
      E.map(c, xt, l),
  ...
  (E.Animation = E.extend(bt, {
        ...
        1 === t.nodeType &&
          ...
          "inline" ===
            ("none" === (l = E.css(t, "display"))
              ? E._data(t, "olddisplay") || Pe(t.nodeName)
              : l) &&
            "none" === E.css(t, "float") &&
            (v.inlineBlockNeedsLayout && "inline" !== Pe(t.nodeName)
              ? (d.zoom = 1)
    ...
    (v.getSetAttribute = "t" !== dt.className),
        ...
        select: {
            ...
            for (
              ...
              if (
                ...
                (!n.parentNode.disabled ||
                  !E.nodeName(n.parentNode, "optgroup"))
              ) {
          ...
          set: function (e, t) {
            for (
              ...
              if (((r = i[a]), 0 <= E.inArray(E.valHooks.option.get(r), o)))
                try {
                  r.selected = n = !0;
                } catch (e) {
                  r.scrollHeight;
  ...
  E.fn.extend({
    ...
    E.extend({
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ...
            : ((1 === o && E.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (i = E.attrHooks[t] || (E.expr.match.bool.test(t) ? Ct : Tt))),
              void 0 !== n
                ? null === n
      ...
      removeAttr: function (e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = E.propFix[n] || n),
              E.expr.match.bool.test(n)
                ? (St && kt) || !Nt.test(n)
                  ? (e[r] = !1)
                  : (e[E.camelCase("default-" + n)] = e[r] = !1)
                : E.attr(e, n, ""),
      ...
      set: function (e, t, n) {
        return (
          !1 === t
            ? E.removeAttr(e, n)
            : (St && kt) || !Nt.test(n)
            ? e.setAttribute((!kt && E.propFix[n]) || n, n)
            : (e[E.camelCase("default-" + n)] = e[n] = !0),
          n
        );
      },
    }),
    E.each(E.expr.match.bool.source.match(/\w+/g), function (e, t) {
      var o = Et[t] || E.find.attr;
      (St && kt) || !Nt.test(t)
        ? (Et[t] = function (e, t, n) {
            var r, i;
            return (
    ...
    (St && kt) ||
      (E.attrHooks.value = {
        set: function (e, t, n) {
          if (!E.nodeName(e, "input")) return Tt && Tt.set(e, t, n);
          e.defaultValue = t;
        },
      }),
    kt ||
      ...
      return "boolean" == typeof t && "string" === o
        ...
        : this.each(function () {
            ...
            if ("string" === o)
              ...
              (void 0 !== i && "boolean" !== o) ||
                ((e = jt(this)) && E._data(this, "__className__", e),
                E.attr(
                  this,
                  "class",
                  e || !1 === i ? "" : E._data(this, "__className__") || ""
                ));
          });
    },
    hasClass: function (e) {
  ...
  E.extend({
    ...
    ajax: function (e, t) {
      ...
      var n,
        ...
        m = E.ajaxSetup({}, t),
        g = m.context || m,
        v = m.context && (g.nodeType || g.jquery) ? E(g) : E.event,
        y = E.Deferred(),
        ...
        T = {
          ...
          getResponseHeader: function (e) {
            ...
            if (2 === w) {
              if (!i)
                for (i = {}; (t = Rt.exec(f)); ) i[t[1].toLowerCase()] = t[2];
              t = i[e.toLowerCase()];
            }
      ...
      m.ifModified &&
        (E.lastModified[c] &&
          T.setRequestHeader("If-Modified-Since", E.lastModified[c]),
      ...
      function u(e, t, n, r) {
        ...
        2 !== w &&
          ...
          (T.status = e),
          (T.statusText = (t || l) + ""),
          i ? y.resolveWith(g, [o, l, T]) : y.rejectWith(g, [T, l, a]),
          T.statusCode(b),
          (b = void 0),
      ...
      return v.reliableHiddenOffsets()
        ...
        : (function (e) {
            for (; e && 1 === e.nodeType; ) {
              if (
                "none" ===
                  (((t = e).style && t.style.display) || E.css(t, "display")) ||
                "hidden" === e.type
              )
                return !0;
              e = e.parentNode;
  ...
  function tn(n, e, r, i) {
    ...
    else for (t in e) tn(n + "[" + t + "]", e[t], r, i);
  }
  ...
  C.attachEvent &&
    ...
    E.ajaxTransport("script", function (t) {
      if (t.crossDomain) {
        var r,
          i = h.head || E("head")[0] || h.documentElement;
        return {
          send: function (e, n) {
  ...
  E.ajaxSetup({
    ...
    (E.parseHTML = function (e, t, n) {
      ...
      "boolean" == typeof t && ((n = t), (t = !1)),
        (t =
          t ||
          (v.createHTMLDocument ? h.implementation.createHTMLDocument("") : h));
      var r = w.exec(e),
        i = !n && [];
      return r
        ? [t.createElement(r[1])]
  ...
  (E.fn.load = function (e, t, n) {
    ...
    var r,
      ...
      s = e.indexOf(" ");
    return (
      -1 < s && ((r = E.trim(e.slice(s, e.length))), (e = e.slice(0, s))),
      E.isFunction(t)
        ? ((n = t), (t = void 0))
    ...
    (E.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          (o = E.css(e, "top")),
          (u = E.css(e, "left")),
          ("absolute" === l || "fixed" === l) && -1 < E.inArray("auto", [o, u])
          ...
          return (
            "fixed" === E.css(r, "position")
              ...
              : ((e = this.offsetParent()),
                ...
                (n.top += E.css(e[0], "borderTopWidth", !0) - e.scrollTop()),
                (n.left +=
                  E.css(e[0], "borderLeftWidth", !0) - e.scrollLeft())),
            {
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !E.nodeName(e, "html") && "static" === E.css(e, "position");
    ...
    E.each(["top", "left"], function (e, n) {
      E.cssHooks[n] = Ve(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Xe(e, n)), We.test(t) ? E(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (E.noConflict = function (e) {
      return C.$ === E && (C.$ = pn), e && C.jQuery === E && (C.jQuery = dn), E;
    }),
    e || (C.jQuery = C.$ = E),
    E
  );
