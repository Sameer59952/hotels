 ...
 */
!(function (a) {
  a.fn.clock = function (e) {
    var o = this,
      r = a.extend({ offset: "+0", type: "analog" }, e);
    setInterval(function () {
      var e = a.calcTime(r.offset).getSeconds();
      if ("analog" == r.type) {
        var t = "rotate(" + 6 * e + "deg)";
        a(o).find(".sec").css({ "-moz-transform": t, "-webkit-transform": t });
      } else a(o).find(".sec").html(e);
    }, 1e3),
      setInterval(function () {
        var e = a.calcTime(r.offset).getHours();
        if ("analog" == r.type) {
          var t = "rotate(" + (30 * e + mins / 2) + "deg)";
          a(o)
            .find(".hour")
            .css({ "-moz-transform": t, "-webkit-transform": t });
        } else {
          var n = 12 < e ? e - 12 : e;
          a(o)
            .find(".hour")
        ...
        var i = e < 12 ? "AM" : "PM";
        a(o).find(".meridiem").html(i);
      }, 1e3),
      setInterval(function () {
        var e = a.calcTime(r.offset).getMinutes();
        if (((e = (e < 10 ? "0" : "") + e), "analog" == r.type)) {
          var t = "rotate(" + 6 * e + "deg)";
          a(o)
            .find(".min")
            .css({ "-moz-transform": t, "-webkit-transform": t });
        } else a(o).find(".min").html(e);
      }, 1e3);
  };
})(jQuery),
  (jQuery.calcTime = function (e) {
    return (
      (d = new Date()),
      (utc = d.getTime() + 6e4 * d.getTimezoneOffset()),
      (nd = new Date(utc + 1e3 * e)),
      nd
    );
  }),
  (function (e) {
    ...
    (e.prototype = {
      ...
      open: function (e) {
        ...
        if (!u.isOpen) {
          ...
          return (
            ...
            u.bgOverlay
              .add(u.wrap)
              .prependTo(u.st.prependTo || d(document.body)),
      ...
      updateItemHTML: function () {
        ...
        var i = u["get" + t.charAt(0).toUpperCase() + t.slice(1)](
          e,
          u.currTemplate[t]
        );
        u.appendContent(i, t),
      ...
      _hasScrollBar: function (e) {
        return (
          (u.isIE7 ? p.height() : document.body.scrollHeight) >
          (e || C.height())
        );
      },
      _setFocus: function () {
              ...
              if (0 < n.length) {
                ...
                "replaceWith" === i
                  ...
                  ? n.is("img")
                    ? n.attr("src", t)
                    : n.replaceWith(
                        d("<img>").attr("src", t).attr("class", n.attr("class"))
                      )
                  : n.attr(r[1], t);
              }
        ...
        getInline: function (e, t) {
          if ((z(), e.src)) {
            ...
            if (i.length) {
              ...
              o &&
                o.tagName &&
                (_ || ((T = n.hiddenClass), (_ = b(T)), (T = "mfp-" + T)),
                (P = i.after(_).detach().removeClass(T))),
    ...
    d.magnificPopup.registerModule(O, {
      ...
      proto: {
        ...
        getAjax: function (o) {
          E && d(document.body).addClass(E), u.updateStatus("loading");
          var e = d.extend(
            {
              url: o.src,
