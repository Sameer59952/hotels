    ...
    f = (j.$Jease$ = {
      ...
      $InOutElastic: function (a) {
        ...
        var b = 0.45,
          d = 0.1125;
        return (a *= 2) < 1
          ? -0.5 * c.q(2, 10 * (a -= 1)) * c.rb(((a - d) * 2 * c.C) / b)
          : c.q(2, -10 * (a -= 1)) * c.rb(((a - d) * 2 * c.C) / b) * 0.5 + 1;
      },
      $InBack: function (a) {
        var b = 1.70158;
        return a * a * ((b + 1) * a - b);
  ...
  var b = (j.$Jssor$ = new (function () {
    ...
    function s(h, l) {
      ...
      function k(b, d, a) {
        ...
        b.zb(p(300, 300));
        return p(
          c.j(e.x, f.x, g.x, h.x) + d / 2,
          c.j(e.y, f.y, g.y, h.y) + a / 2
        );
      }
      function a(d, a) {
        a = a || {};
  ...
  var i =
    ...
    (j.module || {}).exports =
      function () {
        ...
        function Xb(a) {
          return !(D & 1) && (a - H < 0.0001 || K - a < 0.0001);
        }
        function dc() {
          Fb = cb;
          Vb = A.he();
        ...
        a.Le = function (a) {
          return c.m(a - H) < 0.0001;
        };
        a.xe = function (a) {
          return c.m(a - K) < 0.0001;
        };
        a.$PlayTo = Ab;
        a.$GoTo = function (a) {
          A.uc(a, a, 0);
