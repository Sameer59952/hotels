...
!(function (e) {
  ...
  (M.ui = M.ui || {}),
      ...
      scrollParent: function (e) {
        var t = this.css("position"),
          ...
          a = this.parents()
            ...
            .eq(0);
        return "fixed" !== t && a.length
          ? a
          : M(this[0].ownerDocument || document);
      },
      uniqueId:
        ((e = 0),
        function () {
    ...
    M.extend(M.expr[":"], {
      ...
      focusable: function (e) {
        return a(e, !isNaN(M.attr(e, "tabindex")));
      },
      tabbable: function (e) {
        var t = M.attr(e, "tabindex"),
          i = isNaN(t);
        return (i || 0 <= t) && a(e, !i);
      },
    }),
    M("<a>").outerWidth(1).jquery ||
      M.each(["Width", "Height"], function (e, i) {
        var a = "Width" === i ? ["Left", "Right"] : ["Top", "Bottom"],
          n = i.toLowerCase(),
          s = {
            innerWidth: M.fn.innerWidth,
            innerHeight: M.fn.innerHeight,
            outerWidth: M.fn.outerWidth,
            outerHeight: M.fn.outerHeight,
          };
        function r(e, t, i, n) {
          return (
            M.each(a, function () {
              (t -= parseFloat(M.css(e, "padding" + this)) || 0),
                i &&
                  (t -= parseFloat(M.css(e, "border" + this + "Width")) || 0),
                n && (t -= parseFloat(M.css(e, "margin" + this)) || 0);
            }),
            t
          );
        }
        (M.fn["inner" + i] = function (e) {
          return void 0 === e
            ? s["inner" + i].call(this)
            : this.each(function () {
                M(this).css(n, r(this, e) + "px");
              });
        }),
          (M.fn["outer" + i] = function (e, t) {
            return "number" != typeof e
              ? s["outer" + i].call(this, e)
              : this.each(function () {
                  M(this).css(n, r(this, e, !0, t) + "px");
                });
          });
      }),
    M.fn.addBack ||
    ...
    M("<a>").data("a-b", "a").removeData("a-b").data("a-b") &&
      (M.fn.removeData =
        ((t = M.fn.removeData),
        function (e) {
          return arguments.length ? t.call(this, M.camelCase(e)) : t.call(this);
        })),
    ...
    M.fn.extend({
      ...
      zIndex: function (e) {
        ...
        if (this.length)
          for (var t, i, n = M(this[0]); n.length && n[0] !== document; ) {
            if (
    ...
    (M.ui.plugin = {
      add: function (e, t, i) {
        var n,
          a = M.ui[e].prototype;
        for (n in i)
          (a.plugins[n] = a.plugins[n] || []), a.plugins[n].push([t, i[n]]);
      },
  ...
  (M.cleanData =
    ...
    (M.widget = function (e, i, t) {
      ...
      return (
        ...
        (n = l + "-" + e),
        t || ((t = i), (i = M.Widget)),
        (M.expr[":"][n.toLowerCase()] = function (e) {
          return !!M.data(e, n);
        }),
        (M[l] = M[l] || {}),
        (a = M[l][e]),
        ...
        (s.prototype = M.widget.extend(
          r,
          { widgetEventPrefix: (a && r.widgetEventPrefix) || e },
          o,
          { constructor: s, namespace: l, widgetName: e, widgetFullName: n }
        )),
        a
          ? (M.each(a._childConstructors, function (e, t) {
              var i = t.prototype;
              M.widget(i.namespace + "." + i.widgetName, s, t._proto);
            }),
    ...
    (M.widget.extend = function (e) {
      for (var t, i, n = l.call(arguments, 1), a = 0, s = n.length; a < s; a++)
        for (t in n[a])
          (i = n[a][t]),
            n[a].hasOwnProperty(t) &&
              void 0 !== i &&
              (M.isPlainObject(i)
                ? (e[t] = M.isPlainObject(e[t])
                    ? M.widget.extend({}, e[t], i)
                    : M.widget.extend({}, i))
                : (e[t] = i));
      return e;
    }),
    (M.widget.bridge = function (s, t) {
          ...
          e
            ? this.each(function () {
                ...
                return "instance" === i
                  ? ((a = t), !1)
                  : t
                  ? M.isFunction(t[i]) && "_" !== i.charAt(0)
                    ? (e = t[i].apply(t, n)) !== t && void 0 !== e
                      ? ((a = e && e.jquery ? a.pushStack(e.get()) : e), !1)
                      : void 0
                    : M.error(
                        "no such method '" +
                          i +
            ...
            : (n.length && (i = M.widget.extend.apply(null, [i].concat(n))),
              this.each(function () {
                var e = M.data(this, r);
                e
                  ? (e.option(i || {}), e._init && e._init())
                  : M.data(this, r, new t(i, this));
              })),
          a
        );
      };
    ...
    (M.Widget.prototype = {
      ...
      _createWidget: function (e, t) {
        (t = M(t || this.defaultElement || this)[0]),
          (this.element = M(t)),
          (this.uuid = o++),
          ...
          (this.focusable = M()),
          t !== this &&
            (M.data(t, this.widgetFullName, this),
            this._on(!0, this.element, {
              remove: function (e) {
                e.target === t && this.destroy();
              },
            }),
            (this.document = M(t.style ? t.ownerDocument : t.document || t)),
            (this.window = M(
      ...
      destroy: function () {
        this._destroy(),
          this.element
            ...
            .removeData(M.camelCase(this.widgetFullName)),
          this.widget()
            .unbind(this.eventNamespace)
      ...
      option: function (e, t) {
        ...
        if ("string" == typeof e)
          if (((s = {}), (e = (i = e.split(".")).shift()), i.length)) {
            for (
              n = s[e] = M.widget.extend({}, this.options[e]), a = 0;
              a < i.length - 1;
              a++
            )
              (n[i[a]] = n[i[a]] || {}), (n = n[i[a]]);
      ...
      _on: function (r, o, e) {
        var l,
          c = this;
        "boolean" != typeof r && ((e = o), (o = r), (r = !1)),
          e
            ? ((o = l = M(o)), (this.bindings = this.bindings.add(o)))
          ...
          M.each(e, function (e, t) {
            ...
            "string" != typeof t &&
              (i.guid = t.guid = t.guid || i.guid || M.guid++);
            var n = e.match(/^([\w:-]*)\s*(.*)$/),
              a = n[1] + c.eventNamespace,
              s = n[2];
            s ? l.delegate(s, a, i) : o.bind(a, i);
          });
      },
      _off: function (e, t) {
        (t =
        ...
        (this.hoverable = this.hoverable.add(e)),
          this._on(e, {
            mouseenter: function (e) {
              M(e.currentTarget).addClass("ui-state-hover");
            },
            mouseleave: function (e) {
              M(e.currentTarget).removeClass("ui-state-hover");
            },
          });
      },
      _focusable: function (e) {
        (this.focusable = this.focusable.add(e)),
          this._on(e, {
            focusin: function (e) {
              M(e.currentTarget).addClass("ui-state-focus");
            },
            focusout: function (e) {
              M(e.currentTarget).removeClass("ui-state-focus");
            },
          });
      },
    ...
    M.each({ show: "fadeIn", hide: "fadeOut" }, function (s, r) {
      M.Widget.prototype["_" + s] = function (t, e, i) {
        "string" == typeof e && (e = { effect: e });
        var n,
          a = e ? (!0 === e || "number" == typeof e ? r : e.effect || r) : s;
        "number" == typeof (e = e || {}) && (e = { duration: e }),
          (n = !M.isEmptyObject(e)),
          (e.complete = i),
          e.delay && t.delay(e.delay),
          n && M.effects && M.effects.effect[a]
            ? t[s](e)
            : a !== s && t[a]
            ? t[a](e.duration, e.easing, i)
            : t.queue(function (e) {
                M(this)[s](), i && i.call(t[0]), e();
              });
      };
    });
  M.widget;
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .bind("click." + this.widgetName, function (e) {
          if (!0 === M.data(e.target, t.widgetName + ".preventClickEvent"))
            return (
              M.removeData(e.target, t.widgetName + ".preventClickEvent"),
      ...
      if (!c) {
        ...
        var t = this,
          ...
          n =
            ...
            M(e.target).closest(this.options.cancel).length;
        return (
          ...
          !this._mouseStarted)
            ? (e.preventDefault(), !0)
            : (!0 ===
                M.data(e.target, this.widgetName + ".preventClickEvent") &&
                M.removeData(e.target, this.widgetName + ".preventClickEvent"),
      ...
      return (
        ...
        this._mouseStarted &&
          ...
          e.target === this._mouseDownEvent.target &&
            M.data(e.target, this.widgetName + ".preventClickEvent", !0),
          this._mouseStop(e)),
        (c = !1)
      );
    },
    ...
    (M.position = {
      ...
      (M.fn.position = function (u) {
        ...
        return (
          ...
          y[0].preventDefault && (u.at = "left top"),
          (p = e.width),
          (f = e.height),
          (g = e.offset),
          (m = M.extend({}, g)),
          M.each(["my", "at"], function () {
            ...
            1 === i.length &&
              ...
              (u[this] = [o.exec(i[0])[0], o.exec(i[1])[0]]);
          }),
          1 === D.length && (D[1] = D[0]),
          "right" === u.at[0]
            ? (m.left += p)
          ...
          this.each(function () {
            var i,
              ...
              t = C(this, "marginLeft"),
              n = C(this, "marginTop"),
              a = o + t + C(this, "marginRight") + _.width,
              s = l + n + C(this, "marginBottom") + _.height,
              c = M.extend({}, m),
              d = S(k.my, r.outerWidth(), r.outerHeight());
            "right" === u.my[0]
              ? (c.left -= o)
              : "center" === u.my[0] && (c.left -= o / 2),
              "bottom" === u.my[1]
                ? (c.top -= l)
                : "center" === u.my[1] && (c.top -= l / 2),
              (c.left += d[0]),
              (c.top += d[1]),
              w || ((c.left = x(c.left)), (c.top = x(c.top))),
              (i = { marginLeft: t, marginTop: n }),
              M.each(["left", "top"], function (e, t) {
                M.ui.position[D[e]] &&
                  M.ui.position[D[e]][t](c, {
                    targetWidth: p,
                    targetHeight: f,
                    elemWidth: o,
                    elemHeight: l,
              ...
              u.using &&
                (e = function (e) {
                  ...
                  p < o && I(t + i) < p && (s.horizontal = "center"),
                    f < l && I(n + a) < f && (s.vertical = "middle"),
                    b(I(t), I(i)) > b(I(n), I(a))
                      ? (s.important = "horizontal")
                      : (s.important = "vertical"),
                    u.using.call(this, e, s);
                }),
              r.offset(M.extend(c, { using: e }));
          })
        );
      }),
      (M.ui.position = {
        fit: {
          left: function (e, t) {
            var i,
              ...
              o = a - r,
              l = r + t.collisionWidth - s - a;
            t.collisionWidth > s
              ? 0 < o && l <= 0
                ? ((i = e.left + o + t.collisionWidth - s - a),
                  (e.left += o - i))
                : (e.left =
                    0 < l && o <= 0 ? a : l < o ? a + s - t.collisionWidth : a)
              : 0 < o
              ? (e.left += o)
              : 0 < l
              ? (e.left -= l)
              : (e.left = b(e.left - r, e.left));
          },
          top: function (e, t) {
            var i,
              n = t.within,
              ...
              o = a - r,
              l = r + t.collisionHeight - s - a;
            t.collisionHeight > s
              ? 0 < o && l <= 0
                ? ((i = e.top + o + t.collisionHeight - s - a),
                  (e.top += o - i))
                : (e.top =
                    0 < l && o <= 0 ? a : l < o ? a + s - t.collisionHeight : a)
              : 0 < o
              ? (e.top += o)
              : 0 < l
              ? (e.top -= l)
              : (e.top = b(e.top - r, e.top));
          },
        },
        flip: {
          left: function (e, t) {
            var i,
              ...
              p = -2 * t.offset[0];
            c < 0
              ? ((i = e.left + u + h + p + t.collisionWidth - r - s) < 0 ||
                  i < I(c)) &&
                (e.left += u + h + p)
              : 0 < d &&
                (0 <
                  (n =
                    e.left - t.collisionPosition.marginLeft + u + h + p - o) ||
                  I(n) < d) &&
                (e.left += u + h + p);
          },
          top: function (e, t) {
            var i,
              ...
              p = -2 * t.offset[1];
            c < 0
              ? ((n = e.top + u + h + p + t.collisionHeight - r - s) < 0 ||
                  n < I(c)) &&
                (e.top += u + h + p)
              : 0 < d &&
                (0 <
                  (i = e.top - t.collisionPosition.marginTop + u + h + p - o) ||
                  I(i) < d) &&
                (e.top += u + h + p);
          },
        },
      ...
      (function () {
        ...
        for (a in ((e = document.createElement(s ? "div" : "body")),
        (i = {
          visibility: "hidden",
          width: 0,
          height: 0,
        ...
        i))
          e.style[a] = i[a];
        e.appendChild(r),
          (t = s || document.documentElement).insertBefore(e, t.firstChild),
  ...
  function f(e, t) {
    for (var i in (M.extend(e, t), t)) null == t[i] && (e[i] = t[i]);
    return e;
  }
  M.extend(M.ui, { datepicker: { version: "1.11.4" } }),
    M.extend(u.prototype, {
      ...
      _attachDatepicker: function (e, t) {
        ...
        (n = "div" === (i = e.nodeName.toLowerCase()) || "span" === i),
          ...
          ((a = this._newInst(M(e), n)).settings = M.extend({}, t || {})),
          "input" === i
            ...
            (t.trigger = M(
              this._get(t, "buttonImageOnly")
                ...
                : M("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(
                      a ? M("<img/>").attr({ src: a, alt: n, title: n }) : n
                    )
            )),
      ...
      _autoSize: function (e) {
        if (this._get(e, "autoSize") && !e.inline) {
          ...
          r.match(/[DM]/) &&
            ((t = function (e) {
              for (a = n = i = 0; a < e.length; a++)
                e[a].length > i && ((i = e[a].length), (n = a));
              return n;
            }),
            s.setMonth(
      ...
      _dialogDatepicker: function (e, t, i, n, a) {
        ...
        return (
          d ||
            ...
            M.data(this._dialogInput[0], "datepicker", d)),
          f(d.settings, n || {}),
          (t = t && t.constructor === Date ? this._formatDate(d, t) : t),
      ...
      _doKeyDown: function (e) {
        ...
        if (((a._keyEvent = !0), M.datepicker._datepickerShowing))
          switch (e.keyCode) {
            case 9:
            ...
            case 13:
              return (
                ...
                (t = M.datepicker._get(a, "onSelect"))
                  ? ((i = M.datepicker._formatDate(a)),
            ...
            case 33:
              M.datepicker._adjustDate(
                e.target,
                e.ctrlKey
                  ? -M.datepicker._get(a, "stepBigMonths")
                  : -M.datepicker._get(a, "stepMonths"),
                "M"
              );
              break;
            case 34:
      ...
      _doKeyPress: function (e) {
        ...
        if (M.datepicker._get(n, "constrainInput"))
          return (
            (t = M.datepicker._possibleChars(
              M.datepicker._get(n, "dateFormat")
            )),
        ...
        if (t.input.val() !== t.lastVal)
          try {
            M.datepicker.parseDate(
              M.datepicker._get(t, "dateFormat"),
              t.input ? t.input.val() : null,
              M.datepicker._getFormatConfig(t)
            ) &&
              (M.datepicker._setDateFromField(t),
              M.datepicker._updateAlternate(t),
        ...
        M.datepicker._isDisabledDatepicker(e) ||
          ...
          !1 !==
            ...
            M(e)
              .parents()
              .each(function () {
                return !(a |= "fixed" === M(this).css("position"));
              }),
            (s = { left: M.datepicker._pos[0], top: M.datepicker._pos[1] }),
            ...
            M.datepicker._updateDatepicker(t),
            (s = M.datepicker._checkOffset(t, s, a)),
            t.dpDiv.css({
              position:
            ...
            t.inline ||
              ((r = M.datepicker._get(t, "showAnim")),
              (o = M.datepicker._get(t, "duration")),
              t.dpDiv.css(
                "z-index",
                (function (e) {
              ...
              M.effects && M.effects.effect[r]
                ? t.dpDiv.show(r, M.datepicker._get(t, "showOptions"), o)
                : t.dpDiv[r || "show"](r ? o : null),
              M.datepicker._shouldFocusInput(t) && t.input.focus(),
              (M.datepicker._curInst = t))));
      },
      _updateDatepicker: function (e) {
        (this.maxRows = 4),
          (d = e).dpDiv.empty().append(this._generateHTML(e)),
          this._attachHandlers(e);
        var t,
          i = this._getNumberOfMonths(e),
          n = i[1],
          a = e.dpDiv.find("." + this._dayOverClass + " a");
        0 < a.length && p.apply(a.get(0)),
          e.dpDiv
            .removeClass(
      ...
      _checkOffset: function (e, t, i) {
        var n = e.dpDiv.outerWidth(),
          ...
          o =
            ...
            (i ? 0 : M(document).scrollLeft()),
          l =
            document.documentElement.clientHeight +
            (i ? 0 : M(document).scrollTop());
        return (
          (t.left -= this._get(e, "isRTL") ? n - s : 0),
          (t.left -=
      ...
      _hideDatepicker: function (e) {
        var t,
          ...
          s = this._curInst;
        !s ||
          (e && s !== M.data(e, "datepicker")) ||
          (this._datepickerShowing &&
            ((t = this._get(s, "showAnim")),
            (i = this._get(s, "duration")),
            (n = function () {
              M.datepicker._tidyDialog(s);
            }),
            M.effects && (M.effects.effect[t] || M.effects[t])
              ? s.dpDiv.hide(t, M.datepicker._get(s, "showOptions"), i, n)
              : s.dpDiv[
                  "slideDown" === t
                    ? "slideUp"
                    : "fadeIn" === t
      ...
      _adjustDate: function (e, t, i) {
        ...
        this._isDisabledDatepicker(n[0]) ||
          (this._adjustInstDate(
            a,
            t + ("M" === i ? this._get(a, "showCurrentAtPos") : 0),
            i
          ),
      ...
      _selectDay: function (e, t, i, n) {
        var a,
          s = M(e);
        M(n).hasClass(this._unselectableClass) ||
      ...
      _selectDate: function (e, t) {
        var i,
          n = M(e),
          a = this._getInst(n[0]);
        (t = null != t ? t : this._formatDate(a)),
          a.input && a.input.val(t),
          this._updateAlternate(a),
          (i = this._get(a, "onSelect"))
            ? i.apply(a.input ? a.input[0] : null, [t, a])
      ...
      parseDate: function (i, s, e) {
        ...
        var n,
          ...
          k = function (e, t, i) {
            ...
            if (
              (M.each(a, function (e, t) {
                var i = t[1];
                if (s.substr(o, i.length).toLowerCase() === i.toLowerCase())
                  return (n = t[0]), (o += i.length), !1;
              }),
              -1 !== n)
            )
              return n + 1;
          ...
          w = function () {
            if (s.charAt(o) !== i.charAt(n))
              throw "Unexpected literal at position " + o;
            o++;
          };
        for (n = 0; n < i.length; n++)
          if (v) "'" !== i.charAt(n) || _("'") ? w() : (v = !1);
          else
            switch (i.charAt(n)) {
              case "d":
                m = D("d");
        ...
        if (o < s.length && ((a = s.substr(o)), !/^\s+/.test(a)))
      ...
      formatDate: function (i, e, t) {
        if (!e) return "";
        var n,
          a = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort,
      ...
      _possibleChars: function (i) {
        ...
        for (n = 0; n < i.length; n++)
          if (t) "'" !== i.charAt(n) || a("'") ? (e += i.charAt(n)) : (t = !1);
          else
            switch (i.charAt(n)) {
              case "d":
              case "m":
        ...
        var i,
          ...
          a =
            null == e || "" === e
              ...
              ? (function (e) {
                  try {
                    return M.datepicker.parseDate(
                      M.datepicker._get(o, "dateFormat"),
                      e,
                      M.datepicker._getFormatConfig(o)
                    );
                  } catch (e) {}
                  for (
                    var t =
                        (e.toLowerCase().match(/^c/)
                          ? M.datepicker._getDate(o)
                          : null) || new Date(),
                      i = t.getFullYear(),
                      n = t.getMonth(),
                      a = t.getDate(),
                    ...
                    switch (r[2] || "d") {
                      ...
                      case "M":
                        (n += parseInt(r[1], 10)),
                          (a = Math.min(a, M.datepicker._getDaysInMonth(i, n)));
                        break;
                      case "y":
                      case "Y":
                        (i += parseInt(r[1], 10)),
              ...
              ? isNaN(e)
                ? t
                : ((i = e), (n = new Date()).setDate(n.getDate() + i), n)
              : new Date(e.getTime());
        return (
          (a = a && "Invalid Date" === a.toString() ? t : a) &&
            (a.setHours(0),
            a.setMinutes(0),
            a.setSeconds(0),
            a.setMilliseconds(0)),
      ...
      _setDate: function (e, t, i) {
        ...
        (e.selectedDay = e.currentDay = r.getDate()),
          ...
          (a === e.selectedMonth && s === e.selectedYear) ||
            i ||
      ...
      _attachHandlers: function (e) {
        ...
        e.dpDiv.find("[data-handler]").map(function () {
          var e = {
            prev: function () {
              M.datepicker._adjustDate(i, -t, "M");
            },
            next: function () {
              M.datepicker._adjustDate(i, +t, "M");
            },
        ...
        for (
          e.drawMonth = G,
            ...
            i = Q
              ...
              : i,
            n = this._canAdjustMonth(e, -1, ee, G)
            ...
            a = Q
              ...
              : a,
            s = this._canAdjustMonth(e, 1, ee, G)
            ...
            o = this._get(e, "gotoCurrent") && e.currentDay ? J : R,
          ...
          for (b = "", this.maxRows = 4, I = 0; I < V[1]; I++) {
            if (
              ((x = this._daylightSavingAdjust(new Date(ee, G, e.selectedDay))),
              (S = " ui-corner-all"),
              (C = ""),
              Z)
            ) {
              if (((C += "<div class='ui-datepicker-group"), 1 < V[1]))
                switch (I) {
                  case 0:
                    (C += " ui-datepicker-group-first"),
                      (S = " ui-corner-" + (K ? "right" : "left"));
                    break;
                  case V[1] - 1:
                    (C += " ui-datepicker-group-last"),
                      (S = " ui-corner-" + (K ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              C +=
                ...
                S +
                "'>" +
                (/all|left/.test(S) && 0 === w ? (K ? s : n) : "") +
                (/all|right/.test(S) && 0 === w ? (K ? n : s) : "") +
            ...
            for (
              C += M + "</tr></thead><tbody>",
                P = this._getDaysInMonth(ee, G),
                ee === e.selectedYear &&
                  G === e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, P)),
                T = (this._getFirstDayOfMonth(ee, G) - d + 7) % 7,
                N = Math.ceil((T + P) / 7),
                F = Z && this.maxRows > N ? this.maxRows : N,
                this.maxRows = F,
                O = this._daylightSavingAdjust(new Date(ee, G, 1 - T)),
                W = 0;
              W < F;
              W++
            ) {
              for (
                ...
                (j = m ? m.apply(e.input ? e.input[0] : null, [O]) : [!0, ""]),
                  (H =
                    ((E = O.getMonth() !== G) && !v) ||
                    !j[0] ||
                    ($ && O < $) ||
                  ...
                  (Y +=
                    "<td class='" +
                    (5 <= (k + d + 6) % 7 ? " ui-datepicker-week-end" : "") +
                    (E ? " ui-datepicker-other-month" : "") +
                    ((O.getTime() === x.getTime() &&
                      G === e.selectedMonth &&
                      e._keyEvent) ||
                    (_.getTime() === O.getTime() && _.getTime() === x.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (H
      ...
      _generateMonthYearHeader: function (e, t, i, n, a, s, r, o) {
        var l,
          ...
          D = "";
        if (s || !m)
          D += "<span class='ui-datepicker-month'>" + r[t] + "</span>";
        else {
          for (
            l = n && n.getFullYear() === i,
              c = a && a.getFullYear() === i,
      ...
      _adjustInstDate: function (e, t, i) {
        var n = e.drawYear + ("Y" === i ? t : 0),
          ...
          s =
            Math.min(e.selectedDay, this._getDaysInMonth(n, a)) +
            ("D" === i ? t : 0),
          r = this._restrictMinMax(
            e,
            this._daylightSavingAdjust(new Date(n, a, s))
          );
    ...
    (M.fn.datepicker = function (e) {
      ...
      M.datepicker.initialized ||
        (M(document).mousedown(M.datepicker._checkExternalClick),
    ...
    (c.fn.cycle = function (o) {
      ...
      return 0 !== this.length || c.isReady
        ? this.each(function () {
            ...
            if (!a.data("cycle.opts")) {
              for (var r in ((!1 === a.data("cycle-log") ||
                (o && !1 === o.log) ||
                (i && !1 === i.log)) &&
                (s = c.noop),
              s("--c2 init--"),
              (e = a.data())))
                e.hasOwnProperty(r) &&
                  ...
                  ((n = e[r]),
                  s(
                    (t = r.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, l)) + ":",
                    n,
                    "(" + typeof n + ")"
                  ),
                  (e[t] = n));
              ((i = c.extend(
                ...
                (i.container = a),
                (i._maxZ = i.maxZ),
                (i.API = c.extend({ _container: a }, c.fn.cycle.API)),
                (i.API.log = s),
                (i.API.trigger = function (e, t) {
                  return i.container.trigger(e, t), i.API;
                }),
                a.data("cycle.opts", i),
                a.data("cycle.API", i.API),
      ...
      (c.fn.cycle.API = {
        ...
        preInitSlideshow: function () {
          ...
          t && c.isFunction(t.preInit) && t.preInit(e),
            (e._preInitialized = !0);
        },
        ...
        initSlideshow: function () {
          ...
          t.API.calcFirstSlide(),
            ...
            t.pauseOnHover &&
              (!0 !== t.pauseOnHover && (i = c(t.pauseOnHover)),
              i.hover(
                function () {
                  t.API.pause(!0);
                },
          ...
          "string" == c.type(e) && (e = c.trim(e)),
            c(e).each(function (e) {
              ...
              n ? a.container.prepend(i) : a.container.append(i),
                ...
                (a.slides = n ? c(i).add(a.slides) : a.slides.add(i)),
            ...
            a._preInitialized &&
              ...
              (a._initialized
                ? a.timeout &&
                  ((t = a.slides.length),
                  (a.nextSlide = a.reverse ? t - 1 : 1),
                  a.timeoutId || a.API.queueTransition(a))
                : a.API.initSlideshow());
        },
        ...
        calcTx: function (e, t) {
          ...
          return (
            n._tempFx
              ? (i = c.fn.cycle.transitions[n._tempFx])
              : t && n.manualFx && (i = c.fn.cycle.transitions[n.manualFx]),
            i || (i = c.fn.cycle.transitions[n.fx]),
            (n._tempFx = null),
            (this.opts()._tempFx = null),
            i ||
              ((i = c.fn.cycle.transitions.fade),
        ...
        prepareTx: function (e, t) {
          ...
          o.slideCount < 2
            ...
            : (!e ||
                ...
                (o.API.stopTransition(),
                (o.busy = !1),
                clearTimeout(o.timeoutId),
                (o.timeoutId = 0)),
              o.busy ||
                ((0 !== o.timeoutId || e) &&
                  ((n = o.slides[o.currSlide]),
                  (a = o.slides[o.nextSlide]),
                  (s = o.API.getSlideOpts(o.nextSlide)),
                  (r = o.API.calcTx(s, e)),
                  (o._tx = r),
                  e && void 0 !== s.manualSpeed && (s.speed = s.manualSpeed),
                  o.nextSlide != o.currSlide &&
                  (e || (!o.paused && !o.hoverPaused && o.timeout))
                    ? (o.API.trigger("cycle-before", [s, n, a, t]),
                      r.before && r.before(s, n, a, t),
                      (i = function () {
                        (o.busy = !1),
                          o.container.data("cycle.opts") &&
                            (r.after && r.after(s, n, a, t),
                            o.API.trigger("cycle-after", [s, n, a, t]),
                            o.API.queueTransition(s),
                            o.API.updateView(!0));
                      }),
                      (o.busy = !0),
                      r.transition
                        ? r.transition(s, n, a, t, i)
                        : o.API.doTransition(s, n, a, t, i),
                      o.API.calcNextSlide(),
                      o.API.updateView())
                    : o.API.queueTransition(s))));
        },
        ...
        queueTransition: function (e, t) {
          ...
          return 0 === i.nextSlide && 0 == --i.loop
            ...
            : void 0 !== i.continueAuto &&
              (!1 === i.continueAuto ||
                (c.isFunction(i.continueAuto) && !1 === i.continueAuto()))
        ...
        buildSlideOpts: function (e) {
          ...
          for (var s in a)
            a.hasOwnProperty(s) &&
              /^cycle[A-Z]+/.test(s) &&
              ((t = a[s]),
              (i = s.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, l)),
              n.API.log(
                "[" + (n.slideCount - 1) + "]",
                i + ":",
                t,
              ...
              (a[i] = t));
          (a = c.extend({}, c.fn.cycle.defaults, n, a)).slideNum = n.slideCount;
          try {
            delete a.API,
              delete a.slideCount,
              delete a.currSlide,
        ...
        updateView: function (e, t, i) {
          ...
          if (n._initialized) {
            ...
            (!e &&
              !0 !== t &&
              (n.API.trigger("cycle-update-view-before", [n, a, s]),
              n.updateView < 0)) ||
              (n.slideActiveClass &&
                n.slides
              ...
              0 === n.updateView &&
                setTimeout(function () {
                  n.API.trigger("cycle-update-view", [n, a, s, e]);
                }, a.speed / (n.sync ? 2 : 1)),
              0 !== n.updateView &&
                n.API.trigger("cycle-update-view", [n, a, s, e]),
              e && n.API.trigger("cycle-update-view-after", [n, a, s]));
          }
        },
        ...
        stackSlides: function (e, t, i) {
          ...
          e ||
            ...
            (t = a.slides[a.nextSlide]),
            (i = !a.reverse)),
            c(e).css("zIndex", a.maxZ);
          var s = a.maxZ - 2,
            r = a.slideCount;
          if (i) {
            for (n = a.currSlide + 1; n < r; n++)
              c(a.slides[n]).css("zIndex", s--);
            for (n = 0; n < a.currSlide; n++) c(a.slides[n]).css("zIndex", s--);
          } else {
            for (n = a.currSlide - 1; 0 <= n; n--)
              c(a.slides[n]).css("zIndex", s--);
            for (n = r - 1; n > a.currSlide; n--)
              c(a.slides[n]).css("zIndex", s--);
          }
          c(t).css("zIndex", a.maxZ - 1);
        },
  ...
  (function (l) {
    ...
    function o(e, t) {
      var i,
        ...
        o = t.autoHeight;
      if ("container" == o)
        (n = l(t.slides[t.currSlide]).outerHeight()), t.container.height(n);
        ...
        if (
          ("calc" === o
            ? ((s = 0),
              ...
              (a = s))
            : (a = o >= t.slides.length ? 0 : o),
          a == t._sentinelIndex)
        )
          return;
        (t._sentinelIndex = a),
          t._sentinel && t._sentinel.remove(),
          (i = l(t.slides[a].cloneNode(!0)))
    ...
    function c(e, t, i, n, a) {
      ...
      t.container.animate({ height: s }, t.autoHeightSpeed, t.autoHeightEasing);
    }
    function d(e, t) {
      t._autoHeightOnResize &&
        (l(window).off("resize orientationchange", t._autoHeightOnResize),
        (t._autoHeightOnResize = null)),
        t.container.off("cycle-slide-added cycle-slide-removed", o),
        t.container.off("cycle-destroyed", d),
        t.container.off("cycle-before", c),
    ...
    l.extend(l.fn.cycle.defaults, {
      ...
      l(document).on("cycle-initialized", function (e, t) {
        ...
        ("string" !== a && "number" !== a) ||
          (t.container.on("cycle-slide-added cycle-slide-removed", o),
          t.container.on("cycle-destroyed", d),
          "container" == n
            ? t.container.on("cycle-before", c)
            : "string" === a &&
              /\d+\:\d+/.test(n) &&
          ...
          "number" !== a &&
            ((t._autoHeightOnResize = function () {
              clearTimeout(s), (s = setTimeout(r, 50));
            }),
            l(window).on("resize orientationchange", t._autoHeightOnResize)),
          setTimeout(r, 30));
      });
  })(jQuery),
  (function (s) {
      ...
      s(document).on("cycle-update-view", function (e, i, n, a) {
        "caption" === i.captionModule &&
          s.each(["caption", "overlay"], function () {
            ...
            t.length && e
              ? (t.html(i.API.tmpl(e, n, i, a)), t.show())
              : t.hide();
          });
      }),
  ...
  (function (o) {
    ...
    (o.fn.cycle = function (t) {
      var i,
        n,
        a,
        s = o.makeArray(arguments);
      return "number" == o.type(t)
        ? this.cycle("goto", t)
        : "string" == o.type(t)
        ? this.each(function () {
            var e;
            if (((i = t), void 0 !== (a = o(this).data("cycle.opts"))))
              return (
                (i = "goto" == i ? "jump" : i),
                (n = a.API[i]),
                o.isFunction(n)
                  ? ((e = o.makeArray(s)).shift(), n.apply(a.API, e))
                  : void r.log("unknown command: ", i)
              );
            r.log(
      ...
      o.extend(r.API, {
        ...
        destroy: function () {
          this.stop();
          var t = this.opts(),
            i = o.isFunction(o._data) ? o._data : o.noop;
          clearTimeout(t.timeoutId),
            (t.timeoutId = 0),
            t.API.stop(),
        ...
        stop: function () {
          ...
          clearTimeout(e.timeoutId),
            ...
            e.pauseOnHover &&
              (!0 !== e.pauseOnHover && (t = o(e.pauseOnHover)),
        ...
        remove: function (e) {
          for (
            ...
            (t = n.slides[r]),
              r == e
                ? (i = t)
                : (a.push(t), (o(t).data("cycle.opts").slideNum = s), s++);
          i &&
            ((n.slides = o(a)),
            n.slideCount--,
            o(i).remove(),
  ...
  (function (s) {
    ...
    s(document).on("cycle-pre-initialize", function (e, t) {
      i(t, !0),
        (t._onHashChange = function () {
          i(t, !1);
        }),
        s(window).on("hashchange", t._onHashChange);
    }),
      s(document).on("cycle-update-view", function (e, t, i) {
        i.hash &&
          "#" + i.hash != window.location.hash &&
          ((t._hashFence = !0), (window.location.hash = i.hash));
      }),
      s(document).on("cycle-destroyed", function (e, t) {
        t._onHashChange && s(window).off("hashchange", t._onHashChange);
      });
  })(jQuery),
  (function (u) {
    "use strict";
        ...
        c.loader &&
          ...
          (c.API.add = function (e, s) {
            ...
            e
              ...
              o && c.container.addClass("cycle-loading");
            function l(e, t) {
  ...
  (function (r) {
    ...
    function n(i, n, a) {
      ...
      i.API.getComponent("pager").each(function () {
        var t = r(this);
        if (n.pagerTemplate) {
          var e = i.API.tmpl(n.pagerTemplate, n, i, a[0]);
          s = r(e).appendTo(t);
        } else s = t.children().eq(i.slideCount - 1);
        s.on(i.pagerEvent, function (e) {
    ...
    r.extend(r.fn.cycle.defaults, {
      ...
      r(document).on("cycle-bootstrap", function (e, t, i) {
        i.buildPagerLink = n;
      }),
      r(document).on("cycle-slide-added", function (e, t, i, n) {
        t.pager && (t.API.buildPagerLink(t, i, n), (t.API.page = a));
      }),
      r(document).on("cycle-slide-removed", function (e, t, i, n) {
        t.pager &&
          t.API.getComponent("pager").each(function () {
            var e = r(this);
            r(e.children()[i]).remove();
          });
      }),
      r(document).on("cycle-update-view", function (e, t, i) {
        t.pager &&
          t.API.getComponent("pager").each(function () {
            r(this)
              .children()
    ...
    e.extend(e.fn.cycle.defaults, {
      ...
      e(document).on("cycle-update-view", function (e, t, i, n) {
        if (!t.allowWrap) {
          ...
          t.currSlide == l
            ? s.addClass(a).prop("disabled", !0)
            : s.removeClass(a).prop("disabled", !1),
            t.currSlide === o
              ? r.addClass(a).prop("disabled", !0)
              : r.removeClass(a).prop("disabled", !1);
        }
      }),
  ...
  (function (c) {
    "use strict";
    c.extend(c.fn.cycle.defaults, { progressive: !1 }),
      c(document).on("cycle-pre-initialize", function (e, a) {
        if (a.progressive) {
          var s,
            t,
            i = a.API,
            ...
            r = i.prev,
            o = i.prepareTx,
            l = c.type(a.progressive);
          if ("array" == l) s = a.progressive;
          else if (c.isFunction(a.progressive)) s = a.progressive(a);
          else if ("string" == l) {
            if (((t = c(a.progressive)), !(s = c.trim(t.html())))) return;
            if (/^(\[)/.test(s))
              try {
                s = c.parseJSON(s);
              } catch (e) {
              ...
              (s = s.split(new RegExp(t.data("cycle-split") || "\n")))[
                s.length - 1
              ] || s.pop();
          }
          o &&
            (i.prepareTx = function (e, t) {
              ...
              e || 0 === s.length
                ? o.apply(a.API, [e, t])
                : t && a.currSlide == a.slideCount - 1
                ? ((n = s[0]),
                  (s = s.slice(1)),
                  a.container.one("cycle-slide-added", function (e, t) {
                    setTimeout(function () {
  ...
  (function (l) {
    ...
    l.extend(l.fn.cycle.defaults, { tmplRegex: "{{((.)?.*?)}}" }),
      l.extend(l.fn.cycle.API, {
        tmpl: function (e, t) {
          var i = new RegExp(t.tmplRegex || l.fn.cycle.defaults.tmplRegex, "g"),
          ...
          return (
            ...
            e.replace(i, function (e, t) {
              ...
              for (i = 0; i < o.length; i++)
                if ((a = o[i])) {
                  if (1 < r.length)
                    for (s = a, n = 0; n < r.length; n++)
                      s = (a = s)[r[n]] || t;
                  else s = a[t];
                  if (l.isFunction(s)) return s.apply(a, o);
  ...
  (function (h) {
    "use strict";
    h(document).on("cycle-bootstrap", function (e, t, i) {
      "carousel" === t.fx &&
      ...
      (h.fn.cycle.transitions.carousel = {
        preInit: function (e) {
          (e.hideNonActive = !1),
            e.container.on("cycle-destroyed", h.proxy(this.onDestroy, e.API)),
            (e.API.stopTransition = this.stopTransition);
          for (var t = 0; t < e.startingSlide; t++)
            e.container.append(e.slides[0]);
        },
        postInit: function (e) {
          var t,
            i,
            n,
            a,
            s = e.carouselVertical;
          e.carouselVisible &&
            e.carouselVisible > e.slideCount &&
            (e.carouselVisible = e.slideCount - 1);
          var r = e.carouselVisible || e.slides.length,
            o = { display: s ? "block" : "inline-block", position: "static" };
          if (
            (e.container.css({ position: "relative", overflow: "hidden" }),
            e.slides.css(o),
            (e._currSlide = e.currSlide),
            (a = h('<div class="cycle-carousel-wrap"></div>')
              .prependTo(e.container)
              .css({
                margin: 0,
                padding: 0,
                top: 0,
              ...
              .append(e.slides)),
            (e._carouselWrap = a),
            s || a.css("white-space", "nowrap"),
            !1 !== e.allowWrap)
          ) {
            for (i = 0; i < (void 0 === e.carouselVisible ? 2 : 1); i++) {
              for (t = 0; t < e.slideCount; t++)
                a.append(e.slides[t].cloneNode(!0));
              for (t = e.slideCount; t--; )
                a.prepend(e.slides[t].cloneNode(!0));
            }
            a.find(".cycle-slide-active").removeClass("cycle-slide-active"),
              e.slides.eq(e.startingSlide).addClass("cycle-slide-active");
          }
          e.pager &&
            !1 === e.allowWrap &&
            ((n = e.slideCount - r),
            h(e.pager)
              ...
              .filter(":gt(" + n + ")")
              .hide()),
            (e._nextBoundry = e.slideCount - e.carouselVisible),
            this.prepareDimensions(e);
        },
        prepareDimensions: function (e) {
          ...
          if (
            (e.carouselFluid && e.carouselVisible
              ? e._carouselResizeThrottle || this.fluidSlides(e)
              : e.carouselVisible && e.carouselSlideDimension
              ? ((t = r * e.carouselSlideDimension),
                e.container[s ? "height" : "width"](t))
              : e.carouselVisible &&
                ((t = r * h(e.slides[0])[s ? "outerHeight" : "outerWidth"](!0)),
                e.container[s ? "height" : "width"](t)),
            (i = e.carouselOffset || 0),
            !1 !== e.allowWrap)
          )
            if (e.carouselSlideDimension)
              i -= (e.slideCount + e.currSlide) * e.carouselSlideDimension;
            else
              for (
                n = e._carouselWrap.children(), a = 0;
                a < e.slideCount + e.currSlide;
                a++
              )
                i -= h(n[a])[s ? "outerHeight" : "outerWidth"](!0);
          e._carouselWrap.css(s ? "top" : "left", i);
        },
        fluidSlides: function (t) {
          ...
          h(window).on("resize", s), (t._carouselResizeThrottle = s), r();
        },
        transition: function (e, t, i, n, a) {
          var s,
            r = {},
            o = e.nextSlide - e.currSlide,
            l = e.carouselVertical,
            c = e.speed;
          if (!1 === e.allowWrap) {
            n = 0 < o;
            var d = e._currSlide,
              u = e.slideCount - e.carouselVisible;
            0 < o && e.nextSlide > u && d == u
              ? (o = 0)
              : 0 < o && e.nextSlide > u
              ? (o = e.nextSlide - d - (e.nextSlide - u))
              : o < 0 && e.currSlide > u && e.nextSlide > u
              ? (o = 0)
              : o < 0 && e.currSlide > u
              ? (o += e.currSlide - u)
              : (d = e.currSlide),
              (s = this.getScroll(e, l, d, o)),
              (e.API.opts()._currSlide = e.nextSlide > u ? u : e.nextSlide);
          } else
            n && 0 === e.nextSlide
              ? ((s = this.getDim(e, e.currSlide, l)),
                (a = this.genCallback(e, n, l, a)))
              : n || e.nextSlide != e.slideCount - 1
              ? (s = this.getScroll(e, l, e.currSlide, o))
              : ((s = this.getDim(e, e.currSlide, l)),
                (a = this.genCallback(e, n, l, a)));
          (r[l ? "top" : "left"] = n ? "-=" + s : "+=" + s),
            e.throttleSpeed &&
              (c = (s / h(e.slides[0])[l ? "height" : "width"]()) * e.speed),
            e._carouselWrap.animate(r, c, e.easing, a);
        },
        getDim: function (e, t, i) {
          return h(e.slides[t])[i ? "outerHeight" : "outerWidth"](!0);
        },
        getScroll: function (e, t, i, n) {
          var a,
            s = 0;
          if (0 < n) for (a = i; a < i + n; a++) s += this.getDim(e, a, t);
          else for (a = i; i + n < a; a--) s += this.getDim(e, a, t);
          return s;
        },
        genCallback: function (t, e, i, n) {
          return function () {
            var e =
              0 -
              h(t.slides[t.nextSlide]).position()[i ? "top" : "left"] +
              (t.carouselOffset || 0);
        ...
        onDestroy: function (e) {
          ...
          t._carouselResizeThrottle &&
            h(window).off("resize", t._carouselResizeThrottle),
    ...
    var y = (f.cookie = function (e, t, i) {
      if (void 0 !== t && !f.isFunction(t)) {
        ...
        return (document.cookie = [
          g(e),
          "=",
          ((s = t), g(y.json ? JSON.stringify(s) : String(s))),
      ...
      for (
        ...
        var u = l[c].split("="),
          h = ((r = u.shift()), y.raw ? r : decodeURIComponent(r)),
          p = u.join("=");
        if (e && e === h) {
          o = m(p, t);
          break;
        }
        e || void 0 === (p = m(p)) || (o[h] = p);
      }
      return o;
    });
    (y.defaults = {}),
      (f.removeCookie = function (e, t) {
        return (
          void 0 !== f.cookie(e) &&
          (f.cookie(e, "", f.extend({}, t, { expires: -1 })), !0)
        );
      });
  }),
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (e, t, i, n, a) {
      ...
      return (
        o * Math.pow(2, -10 * t) * Math.sin(((t * a - s) * (2 * Math.PI)) / r) +
        n +
        i
      );
    },
    ...
    easeInBack: function (e, t, i, n, a, s) {
      return (
        null == s && (s = 1.70158), n * (t /= a) * t * ((s + 1) * t - s) + i
      );
    },
    easeOutBack: function (e, t, i, n, a, s) {
      return (
        null == s && (s = 1.70158),
        n * ((t = t / a - 1) * t * ((s + 1) * t + s) + 1) + i
      );
    },
    ...
    easeInOutBounce: function (e, t, i, n, a) {
      return t < a / 2
        ? 0.5 * jQuery.easing.easeInBounce(e, 2 * t, 0, n, a) + i
        : 0.5 * jQuery.easing.easeOutBounce(e, 2 * t - a, 0, n, a) +
            0.5 * n +
            i;
    },
  });
