...
if (
  ((function (kt) {
    kt.fn.camera = function (U, t) {
      ...
      var B = kt(this).addClass("camera_wrap");
      B.wrapInner('<div class="camera_src" />').wrapInner(
        '<div class="camera_fakehover" />'
      );
      var q,
        G = kt(".camera_fakehover", B);
      G.append('<div class="camera_target"></div>'),
        1 == U.overlayer && G.append('<div class="camera_overlayer"></div>'),
        G.append('<div class="camera_target_content"></div>'),
        "pie" ==
        (q =
          "pie" == U.loader && kt.browser.msie && kt.browser.version < 9
            ? "bar"
            : U.loader)
        ...
        1 == U.playPause && G.append('<div class="camera_commands"></div>'),
        1 == U.navigation &&
          G.append('<div class="camera_prev"><span></span></div>').append(
            '<div class="camera_next"><span></span></div>'
          ),
        1 == U.thumbnails && B.append('<div class="camera_thumbs_cont" />'),
        1 == U.thumbnails &&
          1 != U.pagination &&
          kt(".camera_thumbs_cont", B)
            .wrap("<div />")
            .wrap('<div class="camera_thumbs" />')
            .wrap("<div />")
            .wrap('<div class="camera_command_wrap" />'),
        1 == U.pagination && B.append('<div class="camera_pag"></div>'),
        B.append('<div class="camera_loader"></div>'),
        kt(".camera_caption", B).each(function () {});
      var V = "pie_" + B.index(),
        Q = kt(".camera_src", B),
        Z = kt(".camera_target", B),
        e = kt(".camera_target_content", B),
        i = kt(".camera_pie", B),
        o = kt(".camera_bar", B),
        s = kt(".camera_prev", B),
        a = kt(".camera_next", B),
        n = kt(".camera_commands", B),
        X = kt(".camera_pag", B),
        J = kt(".camera_thumbs_cont", B),
        K = new Array();
      kt("> div", Q).each(function () {
        K.push(kt(this).attr("data-src"));
      });
      var tt = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-alt")
          ? tt.push(kt(this).attr("data-alt"))
          : tt.push("");
      });
      var r = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-link")
          ? r.push(kt(this).attr("data-link"))
          : r.push("");
      });
      var l = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-target")
          ? l.push(kt(this).attr("data-target"))
          : l.push("");
      });
      var et = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-portrait")
          ? et.push(kt(this).attr("data-portrait"))
          : et.push("");
      });
      var it = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-alignment")
          ? it.push(kt(this).attr("data-alignment"))
          : it.push("");
      });
      var d = new Array();
      kt("> div", Q).each(function () {
        kt(this).attr("data-thumb")
          ? d.push(kt(this).attr("data-thumb"))
          : d.push("");
      });
      var c,
        ot = K.length;
      for (kt(e).append('<div class="cameraContents" />'), c = 0; c < ot; c++)
        if (
          (kt(".cameraContents", e).append('<div class="cameraContent" />'),
          "" != r[c])
        ) {
          var h = kt("> div ", Q).eq(c).attr("data-box");
          (h =
            void 0 !== h && !1 !== h && "" != h
              ? 'data-box="' + kt("> div ", Q).eq(c).attr("data-box") + '"'
              : ""),
            kt(".camera_target_content .cameraContent:eq(" + c + ")", B).append(
      ...
      kt(".camera_caption", B).each(function () {
        var t = kt(this).parent().index(),
          e = B.find(".cameraContent .container").eq(t);
        kt(this).appendTo(e);
      }),
        Z.append('<div class="cameraCont" />');
      var p,
        u,
        st = kt(".cameraCont", B);
      for (p = 0; p < ot; p++) {
        st.append('<div class="cameraSlide cameraSlide_' + p + '" />');
        var f = kt("> div:eq(" + p + ")", Q);
        Z.find(".cameraSlide_" + p).clone(f);
      }
      function m() {
        var a = kt(J).width();
        kt("li", J).removeClass("camera_visThumb"),
          kt("li", J).each(function () {
            var t = kt(this).position(),
              e = kt("ul", J).outerWidth(),
              i = kt("ul", J).offset().left,
              o = kt("> div", J).offset().left - i;
            0 < o
              ? kt(".camera_prevThumbs", ut).removeClass("hideNav")
              : kt(".camera_prevThumbs", ut).addClass("hideNav"),
              a < e - o
                ? kt(".camera_nextThumbs", ut).removeClass("hideNav")
                : kt(".camera_nextThumbs", ut).addClass("hideNav");
            var s = t.left;
            t.left + kt(this).width() - o <= a &&
              0 <= s - o &&
              kt(this).addClass("camera_visThumb");
          });
      }
      kt(window).bind("load resize pageshow", function () {
        bt(), m();
      }),
        st.append('<div class="cameraSlide cameraSlide_' + p + '" />'),
        B.show();
      ...
      function ct() {
        var t;
        function e() {
          if (((lt = B.width()), -1 != U.height.indexOf("%"))) {
            var t = Math.round(lt / (100 / parseFloat(U.height)));
            (dt =
              "" != U.minHeight && t < parseFloat(U.minHeight)
                ? parseFloat(U.minHeight)
                : t),
              B.css({ height: dt });
          } else
            "auto" == U.height
              ? (dt = B.height())
              : ((dt = parseFloat(U.height)), B.css({ height: dt }));
          kt(".camerarelative", Z).css({ width: lt, height: dt }),
            kt(".imgLoaded", Z).each(function () {
              var t,
                e,
                i = kt(this),
                o = i.attr("width"),
                s = i.attr("height"),
                a = (i.index(), i.attr("data-alignment")),
                n = i.attr("data-portrait");
              if (
                ((void 0 !== a && !1 !== a && "" !== a) || (a = U.alignment),
                (void 0 !== n && !1 !== n && "" !== n) || (n = U.portrait),
                0 == n || "false" == n)
              )
                if (o / s < lt / dt) {
                  var r = lt / o,
                    l = 0.5 * Math.abs(dt - s * r);
                  switch (a) {
                    case "topLeft":
                    case "topCenter":
                    case "topRight":
        ...
        1 == u ? (clearTimeout(t), (t = setTimeout(e, 200))) : e(), (u = !0);
      }
      if (
        (kt(window).bind("resize pageshow", function () {
          1 == u && ct(),
            kt("ul", J).animate({ "margin-top": 0 }, 0, bt),
            Q.hasClass("paused") ||
              (Q.addClass("paused"),
              kt(".camera_stop", ut).length &&
                (kt(".camera_stop", ut).hide(), kt(".camera_play", ut).show()),
              "none" != q && kt("#" + V).hide(),
              clearTimeout(g),
              (g = setTimeout(function () {
                Q.removeClass("paused"),
                  kt(".camera_play", ut).length &&
                    (kt(".camera_play", ut).hide(),
                    kt(".camera_stop", ut).show()),
                  "none" != q && kt("#" + V).fadeIn();
              }, 1500)));
        }),
        0 ==
          (v =
            j() && "" != U.mobileAutoAdvance
              ? U.mobileAutoAdvance
              : U.autoAdvance) && Q.addClass("paused"),
        (y =
          j() && "" != U.mobileNavHover ? U.mobileNavHover : U.navigationHover),
        0 != Q.length)
      ) {
        var ht = kt(".cameraSlide", Z);
        ht.wrapInner('<div class="camerarelative" />');
        var pt = U.barDirection,
          ut = B;
        function ft() {
          kt("iframe", G).each(function () {
            kt(".camera_caption", G).show();
            var t = kt(this),
              e = t.attr("data-src");
            t.attr("src", e);
            var i = U.imagePath + "blank.gif",
              o = new Image();
            if (((o.src = i), -1 != U.height.indexOf("%"))) {
              var s = Math.round(lt / (100 / parseFloat(U.height)));
              dt =
                "" != U.minHeight && s < parseFloat(U.minHeight)
                  ? parseFloat(U.minHeight)
                  : s;
            } else dt = "auto" == U.height ? B.height() : parseFloat(U.height);
            t.after(kt(o).attr({ class: "imgFake", width: lt, height: dt }));
            var a = t.clone();
            t.remove(),
              kt(o).bind("click", function () {
                "absolute" == kt(this).css("position")
                  ? (kt(this).remove(),
                    -1 != e.indexOf("vimeo") || -1 != e.indexOf("youtube")
                      ? -1 != e.indexOf("?")
                        ? (autoplay = "&autoplay=1")
                        : (autoplay = "?autoplay=1")
                      : -1 != e.indexOf("dailymotion") &&
                        (-1 != e.indexOf("?")
                          ? (autoplay = "&autoPlay=1")
                          : (autoplay = "?autoPlay=1")),
                    a.attr("src", e + autoplay),
                    (rt = !0))
                  : (kt(this)
                      .css({
                        position: "absolute",
        ...
        kt("iframe", G).each(function () {
          var t = kt(this),
            e = t.attr("src");
          t.attr("data-src", e);
          var i = t.parent().index(".camera_src > div");
          kt(".camera_target_content .cameraContent:eq(" + i + ")", B).append(
            t
          );
        }),
          ft(),
          ...
          1 == y &&
            (kt(s, B).animate({ opacity: 1 }, 0),
            kt(a, B).animate({ opacity: 1 }, 0),
            kt(n, B).animate({ opacity: 1 }, 0),
            j()
              ? (G.on("vmouseover", function () {
                  kt(s, B).animate({ opacity: 1 }, 200),
                    kt(a, B).animate({ opacity: 1 }, 200),
                    kt(n, B).animate({ opacity: 1 }, 200);
                }),
                G.on("vmouseout", function () {
                  kt(s, B).delay(500).animate({ opacity: 1 }, 200),
                    kt(a, B).delay(500).animate({ opacity: 1 }, 200),
                    kt(n, B).delay(500).animate({ opacity: 1 }, 200);
                }))
              : G.hover(
                  function () {
                    kt(s, B).animate({ opacity: 1 }, 200),
          ...
          kt("div", ut).on("click", ".camera_stop", function () {
            (v = !1),
              Q.addClass("paused"),
              kt(".camera_stop", ut).length &&
                (kt(".camera_stop", ut).hide(), kt(".camera_play", ut).show()),
          ...
          kt("div", ut).on("click", ".camera_play", function () {
            (v = !0),
              Q.removeClass("paused"),
              kt(".camera_play", ut).length &&
                (kt(".camera_play", ut).hide(), kt(".camera_stop", ut).show()),
              "none" != q && kt("#" + V).show();
          }),
          1 == U.pauseOnClick &&
            kt(".camera_target_content", G).mouseup(function () {
              (v = !1),
                Q.addClass("paused"),
                kt(".camera_stop", ut).hide(),
                kt(".camera_play", ut).show(),
                kt("#" + V).hide();
            }),
          kt(".cameraContent, .imgFake", G).hover(
            function () {
              b = !0;
            },
            function () {
          ...
          kt(".cameraContent, .imgFake", G).bind("click", function () {
            1 == rt &&
              1 == b &&
              ((v = !1),
              kt(".camera_caption", G).hide(),
              Q.addClass("paused"),
              kt(".camera_stop", ut).hide(),
              kt(".camera_play", ut).show(),
              kt("#" + V).hide());
      ...
      function mt(t) {
        for (
          var e, i, o = t.length;
          o;
          e = parseInt(Math.random() * o), i = t[--o], t[o] = t[e], t[e] = i
        );
        return t;
      }
      if ("pie" != q) {
        switch (
          ...
          kt(".camera_bar_cont", o)
            .animate({ opacity: U.loaderOpacity }, 0)
            .css({
              position: "absolute",
              left: 0,
              right: 0,
              top: 0,
              bottom: 0,
              "background-color": U.loaderBgColor,
            })
            .append('<span id="' + V + '" />'),
          kt("#" + V).animate({ opacity: 0 }, 0),
          (w = kt("#" + V)).css({
            position: "absolute",
            "background-color": U.loaderColor,
          }),
          U.barPosition)
        ) {
          case "left":
            o.css({ right: "auto", width: U.loaderStroke });
            break;
          case "right":
            o.css({ left: "auto", width: U.loaderStroke });
            break;
          case "top":
            o.css({ bottom: "auto", height: U.loaderStroke });
            break;
          case "bottom":
            o.css({ top: "auto", height: U.loaderStroke });
        }
        switch (pt) {
          case "leftToRight":
          case "rightToLeft":
            w.css({
              ...
              right: 0,
              top: U.loaderPadding,
              bottom: U.loaderPadding,
            });
            break;
          case "topToBottom":
          case "bottomToTop":
            w.css({
              left: U.loaderPadding,
              right: U.loaderPadding,
              top: 0,
              bottom: 0,
            });
        }
        ...
        var w, _, gt, vt;
        switch (
          (i.append('<canvas id="' + V + '"></canvas>'),
          (w = document.getElementById(V)).setAttribute("width", U.pieDiameter),
          w.setAttribute("height", U.pieDiameter),
          U.piePosition)
        ) {
          case "leftTop":
            _ = "left:0; top:0;";
        ...
        if (
          (w.setAttribute("style", "position:absolute; z-index:1002; " + _),
          w && w.getContext)
        ) {
          var yt = w.getContext("2d");
          yt.rotate(1.5 * Math.PI), yt.translate(-U.pieDiameter, 0);
        }
      }
      if (
        (("none" != q && 0 != v) ||
          (kt("#" + V).hide(), kt(".camera_canvas_wrap", ut).hide()),
        kt(X).length)
      ) {
        var k;
        for (kt(X).append('<ul class="camera_pag_ul" />'), k = 0; k < ot; k++)
          kt(".camera_pag_ul", B).append(
            '<li class="pag_nav_' +
              k +
        ...
        kt(".camera_pag_ul li", B).hover(
          function () {
            if (
              (kt(this).addClass("camera_hover"),
              kt(".camera_thumb", this).length)
            ) {
              var t = kt(".camera_thumb", this).outerWidth(),
                e = kt(".camera_thumb", this).outerHeight(),
                i = kt(this).outerWidth();
              kt(".camera_thumb", this)
                .show()
                .css({ top: "-" + e + "px", left: "-" + (t - i) / 2 + "px" })
          ...
          function () {
            kt(this).removeClass("camera_hover"),
              kt(".camera_thumb", this).animate(
                { "margin-top": "-20px", opacity: 0 },
                200,
                function () {
                  kt(this).css({ marginTop: "5px" }).hide();
                }
              ),
              kt(".thumb_arrow", this).animate(
                { "margin-top": "-20px", opacity: 0 },
                200,
                function () {
                  kt(this).css({ marginTop: "5px" }).hide();
      ...
      kt(J).length
        ? kt(X).length
          ? (kt.each(d, function (t, e) {
              if ("" != kt("> div", Q).eq(t).attr("data-thumb")) {
                var i = kt("> div", Q).eq(t).attr("data-thumb"),
                  o = new Image();
                (o.src = i),
                  kt("li.pag_nav_" + t, X).append(
                    kt(o)
                      .attr("class", "camera_thumb")
                      .css({ position: "absolute" })
                      .animate({ opacity: 0 }, 0)
                  ),
                  kt("li.pag_nav_" + t + " > img", X).after(
                    '<div class="thumb_arrow" />'
                  ),
                  kt("li.pag_nav_" + t + " > .thumb_arrow", X).animate(
                    { opacity: 0 },
                    0
                  );
              }
            }),
            B.css({ marginBottom: kt(X).outerHeight() }))
          : (kt(J).append("<div />"),
            kt(J)
              .before(
            ...
            kt.each(d, function (t, e) {
              if ("" != kt("> div", Q).eq(t).attr("data-thumb")) {
                ...
                (o.src = i),
                  kt("ul", J).append(
                    '<li class="pix_thumb pix_thumb_' + t + '" />'
                  ),
                  kt("li.pix_thumb_" + t, J).append(
                    kt(o).attr("class", "camera_thumb")
                  );
              }
            }))
        : !kt(J).length &&
      ...
      var T = !0;
      function bt() {
        if (kt(J).length && !kt(X).length) {
          var t,
            e = kt(J).outerWidth(),
            i =
              (kt("ul > li", J).outerWidth(),
              kt("li.cameracurrent", J).length
                ? kt("li.cameracurrent", J).position()
                : ""),
            o = kt("ul > li", J).length * kt("ul > li", J).outerWidth(),
            s = kt("ul", J).offset().left,
            a = kt("> div", J).offset().left;
          (t = s < 0 ? "-" + (a - s) : a - s),
            1 == T &&
              (kt("ul", J).width(
                kt("ul > li", J).length * kt("ul > li", J).outerWidth()
              ),
              kt(J).length &&
                !kt(X).lenght &&
                B.css({ marginBottom: kt(J).outerHeight() }),
              m(),
              kt("ul", J).width(
                kt("ul > li", J).length * kt("ul > li", J).outerWidth()
              ),
              kt(J).length &&
                ...
                B.css({ marginBottom: kt(J).outerHeight() })),
            (T = !1);
          var n = kt("li.cameracurrent", J).length ? i.left : "",
            r = kt("li.cameracurrent", J).length
              ? i.left + kt("li.cameracurrent", J).outerWidth()
              : "";
          n < kt("li.cameracurrent", J).outerWidth() && (n = 0),
            e < r - t
              ? n + e < o
                ? kt("ul", J).animate({ "margin-left": "-" + n + "px" }, 500, m)
                : kt("ul", J).animate(
                    {
                      "margin-left":
                        "-" + (kt("ul", J).outerWidth() - e) + "px",
                    },
                    500,
                    m
                  )
      ...
      function wt() {
        gt = 0;
        var t = kt(".camera_bar_cont", ut).width(),
          e = kt(".camera_bar_cont", ut).height();
        if ("pie" != q)
          switch (pt) {
            case "leftToRight":
              kt("#" + V).css({ right: t });
        ...
        else yt.clearRect(0, 0, U.pieDiameter, U.pieDiameter);
      }
      function _t(t) {
        Q.addClass("camerasliding"), (rt = !1);
        var a = parseFloat(kt("div.cameraSlide.cameracurrent", Z).index());
        if (0 < t) var l = t - 1;
        else if (a == ot - 1) l = 0;
        else l = a + 1;
        var e = kt(".cameraSlide:eq(" + l + ")", Z),
          i = kt(".cameraSlide:eq(" + (l + 1) + ")", Z).addClass("cameranext");
        if (
          (a != l + 1 && i.hide(),
          kt(".cameraContent", G).fadeOut(600),
          kt(".camera_caption", G).show(),
          kt(".camerarelative", e).append(
            kt("> div ", Q).eq(l).find("> div.camera_effected")
          ),
          kt(".camera_target_content .cameraContent:eq(" + l + ")", B).append(
            kt("> div ", Q).eq(l).find("> div")
          ),
          kt(".imgLoaded", e).length)
        ) {
          if (K.length > l + 1 && !kt(".imgLoaded", i).length) {
            var o = K[l + 1],
              s = new Image();
            (s.src = o + "?" + new Date().getTime()),
              i.prepend(
                kt(s).attr("class", "imgLoaded").css("visibility", "hidden")
              ),
              (s.onload = function () {
                (R = s.naturalWidth),
                  (H = s.naturalHeight),
                  kt(s)
                    .attr("data-alignment", it[l + 1])
                    .attr("data-portrait", et[l + 1]),
                  kt(s).attr("width", R),
                  kt(s).attr("height", H),
                  ct();
              });
          }
          U.onLoaded.call(this),
            kt(".camera_loader", B).is(":visible")
              ? kt(".camera_loader", B).fadeOut(400)
              : (kt(".camera_loader", B).css({ visibility: "hidden" }),
                kt(".camera_loader", B).fadeOut(400, function () {
                  kt(".camera_loader", B).css({ visibility: "visible" });
                }));
          var n,
            d,
            r,
          ...
          (marginLeft = 0),
            (marginTop = 0),
            (opacityOnGrid = 0),
            1 == U.opacityOnGrid ? (opacityOnGrid = 0) : (opacityOnGrid = 1);
          var v = kt(" > div", Q).eq(l).attr("data-fx");
          if (
            ("random" ==
            (c =
              j() && "" != U.mobileFx && "default" != U.mobileFx
                ? U.mobileFx
                : void 0 !== v && !1 !== v && "default" !== v
                ? v
                : U.fx)
              ? (c = (c = mt(g))[0])
              : 0 < (c = c).indexOf(",") &&
                (c = (c = mt((c = (c = c.replace(/ /g, "")).split(","))))[0]),
            (dataEasing = kt(" > div", Q).eq(l).attr("data-easing")),
            (mobileEasing = kt(" > div", Q).eq(l).attr("data-mobileEasing")),
            (h =
              j() && "" != U.mobileEasing && "default" != U.mobileEasing
                ...
                ? dataEasing
                : U.easing),
            void 0 !== (n = kt(" > div", Q).eq(l).attr("data-slideOn")) &&
              !1 !== n)
          )
            y = n;
          else if ("random" == U.slideOn) {
            var y = new Array("next", "prev");
            y = (y = mt(y))[0];
          } else y = U.slideOn;
          var b = kt(" > div", Q).eq(l).attr("data-time");
          d = void 0 !== b && !1 !== b && "" !== b ? parseFloat(b) : U.time;
          var w = kt(" > div", Q).eq(l).attr("data-transPeriod");
          switch (
            ((r =
              void 0 !== w && !1 !== w && "" !== w
                ? parseFloat(w)
                : U.transPeriod),
            kt(Q).hasClass("camerastarted") ||
              ((c = "simpleFade"),
              (y = "next"),
              (h = ""),
              (r = 400),
              kt(Q).addClass("camerastarted")),
            c)
          ) {
            case "simpleFade":
              p = u = 1;
            ...
            case "curtainSliceRight":
              (u = 0 == U.slicedCols ? U.cols : U.slicedCols), (p = 1);
              break;
            ...
            case "blindCurtainSliceBottom":
              (p = 0 == U.slicedRows ? U.rows : U.slicedRows), (u = 1);
              break;
            case "stampede":
              m = "-" + r;
              break;
            ...
            case "mosaicSpiralReverse":
              (m = U.gridDifference), (f = 1.7);
              break;
            case "topLeftBottomRight":
            case "bottomRightTopLeft":
            case "bottomLeftTopRight":
            case "topRightBottomLeft":
              (m = U.gridDifference), (f = 6);
              break;
            case "scrollLeft":
            case "scrollRight":
            case "scrollTop":
          ...
          for (
            ...
            var L = kt(".cameraappended:eq(" + T + ")", Z);
            "scrollLeft" == c ||
            "scrollRight" == c ||
            "scrollTop" == c ||
            "scrollBottom" == c ||
            "scrollHorz" == c
              ? ht.eq(l).clone().show().appendTo(L)
              : "next" == y
              ? ht.eq(l).clone().show().appendTo(L)
              : ht.eq(a).clone().show().appendTo(L),
              (_ = T % u < C ? 1 : 0),
              T % u == 0 && (x = 0),
              (k = Math.floor(T / u) < $ ? 1 : 0),
              L.css({
                height: Math.floor(dt / p + k + 1),
                left: x,
                top: D,
                width: Math.floor(lt / u + _ + 1),
              }),
              kt("> .cameraSlide", L).css({
                height: dt,
                "margin-left": "-" + x + "px",
                "margin-top": "-" + D + "px",
                width: lt,
          ...
          switch (c) {
            ...
            case "mosaicSpiral":
              var A = p / 2,
                F = 0;
              for (E = 0; E < A; E++) {
                for (Y = P = E; Y < u - E - 1; Y++) I[F++] = P * u + Y;
                for (Y = u - E - 1, P = E; P < p - E - 1; P++)
                  I[F++] = P * u + Y;
                for (P = p - E - 1, Y = u - E - 1; E < Y; Y--)
                  I[F++] = P * u + Y;
                for (P = p - (Y = E) - 1; E < P; P--) I[F++] = P * u + Y;
              }
              M = I;
              break;
            case "mosaicSpiralReverse":
            ...
            case "topLeftBottomRight":
              for (var P = 0; P < p; P++)
                for (var Y = 0; Y < u; Y++) I.push(Y + P);
              O = I;
              break;
            case "bottomRightTopLeft":
              for (P = 0; P < p; P++) for (Y = 0; Y < u; Y++) I.push(Y + P);
              O = I.reverse();
              break;
            case "bottomLeftTopRight":
              for (P = p; 0 < P; P--) for (Y = 0; Y < u; Y++) I.push(Y + P);
              O = I;
              break;
            case "topRightBottomLeft":
              for (P = 0; P < p; P++) for (Y = u; 0 < Y; Y--) I.push(Y + P);
              O = I;
          }
          kt.each(M, function (t, e) {
            switch (
              ((_ = e % u < C ? 1 : 0),
              e % u == 0 && (x = 0),
              (k = Math.floor(e / u) < $ ? 1 : 0),
              c)
            ) {
              case "simpleFade":
                (height = dt), (width = lt), (opacityOnGrid = 0);
                break;
              case "curtainTopLeft":
              case "curtainTopRight":
                (height = 0),
                  (width = Math.floor(lt / u + _ + 1)),
                  (marginTop = "-" + Math.floor(dt / p + k + 1) + "px");
                break;
              case "curtainBottomLeft":
              case "curtainBottomRight":
                (height = 0),
              ...
              case "curtainSliceRight":
                (height = 0),
                  ...
                  (marginTop =
                    e % 2 == 0
                      ? Math.floor(dt / p + k + 1) + "px"
                      : "-" + Math.floor(dt / p + k + 1) + "px");
                break;
              case "blindCurtainTopLeft":
                (height = Math.floor(dt / p + k + 1)),
                  (width = 0),
                  (marginLeft = "-" + Math.floor(lt / u + _ + 1) + "px");
                break;
              case "blindCurtainTopRight":
                (height = Math.floor(dt / p + k + 1)),
                  (width = 0),
              ...
              case "stampede":
                (height = 0),
                  (width = 0),
                  (marginLeft =
                    0.2 * lt * ((t % u) - (u - Math.floor(u / 2))) + "px"),
                  (marginTop =
                    0.2 *
                      dt *
                      (Math.floor(t / u) + 1 - (p - Math.floor(p / 2))) +
                    "px");
                break;
              case "mosaic":
                (height = 0), (width = 0);
              ...
              case "mosaicSpiralReverse":
                (height = 0),
                  (width = 0),
                  (marginLeft = 0.5 * Math.floor(lt / u + _ + 1) + "px"),
                  (marginTop = 0.5 * Math.floor(dt / p + k + 1) + "px");
                break;
              case "topLeftBottomRight":
                (height = 0), (width = 0);
                break;
              ...
              case "topRightBottomLeft":
                ...
                break;
              case "scrollRight":
                (height = dt), (width = lt), (marginLeft = -lt);
                break;
              case "scrollLeft":
                (height = dt), (width = lt), (marginLeft = lt);
                break;
              case "scrollTop":
                (height = dt), (width = lt), (marginTop = dt);
                break;
              case "scrollBottom":
                (height = dt), (width = lt), (marginTop = -dt);
                break;
            ...
            var i = kt(".cameraappended:eq(" + e + ")", Z);
            void 0 !== at &&
              (clearInterval(at),
              clearTimeout(nt),
              (nt = setTimeout(wt, r + m))),
              kt(X).length &&
                (kt(".camera_pag li", B).removeClass("cameracurrent"),
                kt(".camera_pag li", B).eq(l).addClass("cameracurrent")),
              kt(J).length &&
                (kt("li", J).removeClass("cameracurrent"),
                kt("li", J).eq(l).addClass("cameracurrent"),
                kt("li", J)
                  .not(".cameracurrent")
                  .find("img")
                  .animate({ opacity: 0.5 }, 0),
                kt("li.cameracurrent img", J).animate({ opacity: 1 }, 0),
                kt("li", J).hover(
                  function () {
                    kt("img", this).stop(!0, !1).animate({ opacity: 1 }, 150);
                  },
                  function () {
                    kt(this).hasClass("cameracurrent") ||
                      kt("img", this)
                        .stop(!0, !1)
                        .animate({ opacity: 0.5 }, 150);
                  }
                ));
            var o = parseFloat(r) + parseFloat(m);
            function s() {
              if (
                (kt(this).addClass("cameraeased"),
                0 <= kt(".cameraeased", Z).length &&
                  kt(J).css({ visibility: "visible" }),
                kt(".cameraeased", Z).length == S)
              ) {
                bt(),
                  kt(
                  ...
                  ht.eq(a).css("z-index", "1").removeClass("cameracurrent"),
                  kt(".cameraContent", G).eq(l).addClass("cameracurrent"),
                  0 <= a &&
                    kt(".cameraContent", G).eq(a).removeClass("cameracurrent"),
                  U.onEndTransition.call(this),
                  "hide" != kt("> div", Q).eq(l).attr("data-video") &&
                    kt(".cameraContent.cameracurrent .imgFake", G).length &&
                    kt(".cameraContent.cameracurrent .imgFake", G).click();
                var r = ht.eq(l).find(".fadeIn").length,
                  n = kt(".cameraContent", G)
                    .eq(l)
                    .find(
                      ".moveFromLeft, .moveFromRight, .moveFromTop, .moveFromBottom, .fadeIn, .fadeFromLeft, .fadeFromRight, .fadeFromTop, .fadeFromBottom"
                    ).length;
                0 != r &&
                  kt(".cameraSlide.cameracurrent .fadeIn", G).each(function () {
                    if ("" != kt(this).attr("data-easing"))
                      var t = kt(this).attr("data-easing");
                    else t = h;
                    var e = kt(this);
                    if (
                      void 0 === e.attr("data-outerWidth") ||
                      !1 === e.attr("data-outerWidth") ||
                      "" === e.attr("data-outerWidth")
                    ) {
                      var i = e.outerWidth();
                      e.attr("data-outerWidth", i);
                    } else i = e.attr("data-outerWidth");
                    if (
                      void 0 === e.attr("data-outerHeight") ||
                      !1 === e.attr("data-outerHeight") ||
                      "" === e.attr("data-outerHeight")
                    ) {
                      var o = e.outerHeight();
                      e.attr("data-outerHeight", o);
                    } else o = e.attr("data-outerHeight");
                    var s = e.position(),
                      a = (s.left, s.top, e.attr("class")),
                      n = e.index();
                    e.parents(".camerarelative").outerHeight(),
                      e.parents(".camerarelative").outerWidth();
                    -1 != a.indexOf("fadeIn")
                      ? e
                          .animate({ opacity: 0 }, 0)
                          .css("visibility", "visible")
                          .delay((d / r) * (0.1 * (n - 1)))
                          .animate({ opacity: 1 }, (d / r) * 0.15, t)
                      : e.css("visibility", "visible");
                  }),
                  kt(".cameraContent.cameracurrent", G).show(),
                  0 != n &&
                    kt(
                      ...
                      var e = kt(this),
                        i = e.position(),
                        o = (i.left, i.top, e.attr("class")),
                        s = e.index(),
                        a = e.outerHeight();
                      -1 != o.indexOf("moveFromLeft")
                        ? (e.css({ left: "-" + lt + "px", right: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate({ left: i.left }, (d / n) * 0.15, t))
                        : -1 != o.indexOf("moveFromRight")
                        ? (e.css({ left: lt + "px", right: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate({ left: i.left }, (d / n) * 0.15, t))
                        : -1 != o.indexOf("moveFromTop")
                        ? (e.css({ top: "-" + dt + "px", bottom: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate(
                              ...
                              t,
                              function () {
                                e.css({ top: "auto", bottom: 0 });
                              }
                            ))
                        : -1 != o.indexOf("moveFromBottom")
                        ? (e.css({ top: dt + "px", bottom: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate({ top: i.top }, (d / n) * 0.15, t))
                        : -1 != o.indexOf("fadeFromLeft")
                        ? (e
                            .animate({ opacity: 0 }, 0)
                            .css({ left: "-" + lt + "px", right: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate(
                        ...
                        : -1 != o.indexOf("fadeFromTop")
                        ? (e
                            .animate({ opacity: 0 }, 0)
                            .css({ top: "-" + dt + "px", bottom: "auto" }),
                          e
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate(
                        ...
                        ? e
                            ...
                            .css("visibility", "visible")
                            .delay((d / n) * (0.1 * (s - 1)))
                            .animate({ opacity: 1 }, (d / n) * 0.15, t)
                        : e.css("visibility", "visible");
                    }),
                  kt(".cameraappended", Z).remove(),
                  Q.removeClass("camerasliding"),
                  ht.eq(a).hide();
                var t,
                  e = kt(".camera_bar_cont", ut).width(),
                  i = kt(".camera_bar_cont", ut).height();
                (t = "pie" != q ? 0.05 : 0.005),
                  kt("#" + V).animate({ opacity: U.loaderOpacity }, 200),
                  (at = setInterval(function () {
                    if (
                      (Q.hasClass("stopped") && clearInterval(at), "pie" != q)
                    )
                      switch (
                        (gt <= 1.002 &&
                        !Q.hasClass("stopped") &&
                      ...
                      (vt = gt),
                        yt.clearRect(0, 0, U.pieDiameter, U.pieDiameter),
                        (yt.globalCompositeOperation = "destination-over"),
                        yt.beginPath(),
                        yt.arc(
                          U.pieDiameter / 2,
                          U.pieDiameter / 2,
                          U.pieDiameter / 2 - U.loaderStroke,
                          0,
                          2 * Math.PI,
                          !1
                        ),
                        (yt.lineWidth = U.loaderStroke),
                        (yt.strokeStyle = U.loaderBgColor),
                        yt.stroke(),
                        yt.closePath(),
                        ...
                        (yt.lineWidth = U.loaderStroke - 2 * U.loaderPadding),
                        (yt.strokeStyle = U.loaderColor),
                        yt.stroke(),
                        yt.closePath(),
                        gt <= 1.002 &&
                        !Q.hasClass("stopped") &&
                        ...
                        !Q.hasClass("hovered")
                          ...
                          : Q.hasClass("stopped") ||
                            ...
                            (clearInterval(at),
                            ft(),
                            kt("#" + V + ", .camera_canvas_wrap", ut).animate(
                              { opacity: 0 },
                              200,
                              function () {
                                clearTimeout(nt),
            ...
            "scrollBottom" == c ||
            "scrollHorz" == c
              ? (U.onStartTransition.call(this),
                (o = 0),
                i
                  .delay(((r + m) / S) * O[t] * f * 0.5)
                  .css({
                    display: "block",
                    height: height,
                ...
                ht
                  ...
                  .animate(
                    ...
                    h,
                    function () {
                      kt(this).css({ "margin-top": 0, "margin-left": 0 });
                    }
                  ))
              : (U.onStartTransition.call(this),
                (o = parseFloat(r) + parseFloat(m)),
                "next" == y
                  ? i
                      .delay(((r + m) / S) * O[t] * f * 0.5)
                      .css({
          ...
          var R,
            ...
            z = tt[l],
            N = new Image();
          (N.src = W + "?" + new Date().getTime()),
            e.css("visibility", "hidden"),
            e.prepend(
              kt(N).attr("class", "imgLoaded").css("visibility", "hidden")
            ),
            (kt(N).get(0).complete &&
              "0" != R &&
              "0" != H &&
              ...
              void 0 !== H &&
              !1 !== H) ||
              (kt(".camera_loader", B).delay(500).fadeIn(400),
              (N.onload = function () {
                (R = N.naturalWidth),
                  (H = N.naturalHeight),
                  kt(N)
                    .attr("data-alignment", it[l])
                    .attr("data-portrait", et[l]),
                  kt(N).attr("width", R),
                  kt(N).attr("height", H),
                  kt(N).attr("alt", z),
                  Z.find(".cameraSlide_" + l)
                    .hide()
                    .css("visibility", "visible"),
                  ct(),
                  _t(l + 1);
      ...
      kt(n).length &&
        ...
        kt(s).length &&
          kt(s).click(function () {
            if (!Q.hasClass("camerasliding")) {
              var t = parseFloat(kt(".cameraSlide.cameracurrent", Z).index());
              clearInterval(at),
                ft(),
                kt("#" + V + ", .camera_canvas_wrap", B).animate(
                  { opacity: 0 },
                  0
                ),
                wt(),
        ...
        j() &&
          (G.bind("swipeleft", function (t) {
            if (!Q.hasClass("camerasliding")) {
              var e = parseFloat(kt(".cameraSlide.cameracurrent", Z).index());
              clearInterval(at),
                ft(),
                kt("#" + V + ", .camera_canvas_wrap", ut).animate(
                  { opacity: 0 },
        ...
        kt(X).length &&
          kt(".camera_pag li", B).click(function () {
            if (!Q.hasClass("camerasliding")) {
              var t = parseFloat(kt(this).index());
              t != parseFloat(kt(".cameraSlide.cameracurrent", Z).index()) &&
                (clearInterval(at),
                ft(),
                kt("#" + V + ", .camera_canvas_wrap", ut).animate(
                  { opacity: 0 },
        ...
        kt(J).length &&
          (kt(".pix_thumb img", J).click(function () {
            if (!Q.hasClass("camerasliding")) {
              var t = parseFloat(kt(this).parents("li").index());
              t != parseFloat(kt(".cameracurrent", Z).index()) &&
                (clearInterval(at),
                ft(),
                kt("#" + V + ", .camera_canvas_wrap", ut).animate(
                  { opacity: 0 },
                ...
                kt(".pix_thumb", J).removeClass("cameracurrent"),
                kt(this).parents("li").addClass("cameracurrent"),
                wt(),
                _t(t + 1),
                bt(),
                U.onStartLoading.call(this));
          ...
          kt(".camera_thumbs_cont .camera_prevThumbs", ut).hover(
            function () {
              kt(this).stop(!0, !1).animate({ opacity: 1 }, 250);
            },
            function () {
              kt(this).stop(!0, !1).animate({ opacity: 0.7 }, 250);
            }
          ),
          kt(".camera_prevThumbs", ut).click(function () {
            var e = 0,
              t = (kt(J).outerWidth(), kt("ul", J).offset().left),
              i = kt("> div", J).offset().left - t;
            kt(".camera_visThumb", J).each(function () {
              var t = kt(this).outerWidth();
              e += t;
            }),
              0 < i - e
                ? kt("ul", J).animate(
                ...
                : kt("ul", J).animate({ "margin-left": 0 }, 500, m);
          }),
          kt(".camera_thumbs_cont .camera_nextThumbs", ut).hover(
            function () {
              kt(this).stop(!0, !1).animate({ opacity: 1 }, 250);
            },
            function () {
          ...
          kt(".camera_nextThumbs", ut).click(function () {
            var e = 0,
              t = kt(J).outerWidth(),
              i = kt("ul", J).outerWidth(),
              o = kt("ul", J).offset().left,
              s = kt("> div", J).offset().left - o;
            kt(".camera_visThumb", J).each(function () {
              var t = kt(this).outerWidth();
              e += t;
            }),
  ...
  (function (i) {
    i.fn.cameraStop = function () {
      var t = i(this),
        e = i(".camera_src", t);
      t.index();
      if ((e.addClass("stopped"), i(".camera_showcommands").length))
        i(".camera_thumbs_wrap", t);
      else;
    };
  })(jQuery),
  (function (e) {
  ...
  function (d) {
    var m,
      o,
      t,
      s = "undefined" != typeof global ? global : this,
      u = Math.round,
      ...
      B = {},
      q = { s: 45, m: 45, h: 22, d: 26, M: 11 },
      G = "DDD w W M D d".split(" "),
      V = "M D H h m s w W".split(" "),
      Q = {
        M: function () {
          return this.month() + 1;
        },
        ...
        YY: function () {
          return ct(this.year() % 100, 2);
        },
        YYYY: function () {
          return ct(this.year(), 4);
        },
        YYYYY: function () {
          return ct(this.year(), 5);
        },
        YYYYYY: function () {
          var t = this.year();
          return (0 <= t ? "+" : "-") + ct(Math.abs(t), 6);
        },
        gg: function () {
          return ct(this.weekYear() % 100, 2);
        },
        gggg: function () {
          return ct(this.weekYear(), 4);
        },
        ggggg: function () {
          return ct(this.weekYear(), 5);
        },
        GG: function () {
          return ct(this.isoWeekYear() % 100, 2);
        },
        GGGG: function () {
          return ct(this.isoWeekYear(), 4);
        },
        GGGGG: function () {
          return ct(this.isoWeekYear(), 5);
        },
        e: function () {
          return this.weekday();
        },
        ...
        SS: function () {
          return ct(bt(this.milliseconds() / 10), 2);
        },
        SSS: function () {
          return ct(this.milliseconds(), 3);
        },
        SSSS: function () {
          return ct(this.milliseconds(), 3);
        },
    ...
    function et(t, e) {
      var i = !0;
      return rt(function () {
        return i && (tt(t), (i = !1)), e.apply(this, arguments);
      }, e);
    }
    function it(e, i) {
      return function (t) {
        return ct(e.call(this, t), i);
      };
    }
    function ot(e, i) {
      return function (t) {
        return this.localeData().ordinal(e.call(this, t), i);
      };
    }
    for (; G.length; ) (t = G.pop()), (Q[t + "o"] = ot(Q[t], t));
    for (; V.length; ) (t = V.pop()), (Q[t + t] = it(Q[t], 2));
    function st() {}
    function at(t, e) {
      !1 !== e && St(t), lt(this, t), (this._d = new Date(+t._d));
    }
    function nt(t) {
      var e = vt(t),
        i = e.year || 0,
      ...
      (this._milliseconds = +c + 1e3 * d + 6e4 * l + 36e5 * r),
        (this._days = +n + 7 * a),
        (this._months = +s + 3 * o + 12 * i),
        (this._data = {}),
        (this._locale = m.localeData()),
        this._bubble();
    }
    function rt(t, e) {
      for (var i in e) K(e, i) && (t[i] = e[i]);
      return (
        K(e, "toString") && (t.toString = e.toString),
        K(e, "valueOf") && (t.valueOf = e.valueOf),
        t
      );
    }
    function lt(t, e) {
      ...
      if (
        ...
        void 0 !== e._pf && (t._pf = e._pf),
        void 0 !== e._locale && (t._locale = e._locale),
        0 < n.length)
      )
        for (i in n) void 0 !== (s = e[(o = n[i])]) && (t[o] = s);
      return t;
    }
    function dt(t) {
    ...
    function ct(t, e, i) {
      for (var o = "" + Math.abs(t), s = 0 <= t; o.length < e; ) o = "0" + o;
      return (s ? (i ? "+" : "") : "-") + o;
    }
    function ht(t, e) {
    ...
    function ut(t, e, i, o) {
      ...
      (o = null == o || o),
        ...
        a && Bt(t, "Date", jt(t, "Date") + a * i),
        n && Ut(t, jt(t, "Month") + n * i),
        o && m.updateOffset(t, a || n);
    }
    function ft(t) {
    ...
    function vt(t) {
      var e,
        i,
        o = {};
      for (i in t) K(t, i) && (e = gt(i)) && (o[e] = t[i]);
      return o;
    }
    function yt(n) {
      var r, l;
      if (0 === n.indexOf("week")) (r = 7), (l = "day");
      else {
      ...
      m[n] = function (i, t) {
        var e,
          ...
          a = [];
        if (
          ("number" == typeof i && ((t = i), (i = d)),
          (o = function (t) {
            var e = m().utc().set(l, t);
            return s.call(m._locale, e, i || "");
          }),
          null != t)
        )
          return o(t);
        for (e = 0; e < r; e++) a.push(o(e));
        return a;
      };
    }
    function bt(t) {
      var e = +t,
        i = 0;
      return (
        0 !== e && isFinite(e) && (i = 0 <= e ? Math.floor(e) : Math.ceil(e)), i
      );
    }
    function wt(t, e) {
    ...
    function _t(t, e, i) {
      return Wt(m([t, 11, 31 + e - i]), e, i).week;
    }
    function kt(t) {
      return Tt(t) ? 366 : 365;
    }
    ...
    function St(t) {
      ...
      t._a &&
        ...
        ((e =
          t._a[l] < 0 || 11 < t._a[l]
            ? l
            : t._a[h] < 1 || t._a[h] > wt(t._a[g], t._a[l])
            ? h
            : t._a[p] < 0 || 23 < t._a[p]
            ? p
            : t._a[f] < 0 || 59 < t._a[f]
            ...
            ? y
            : -1),
        t._pf._overflowDayOfYear && (e < g || h < e) && (e = h),
        (t._pf.overflow = e));
    }
    function Ct(t) {
      return (
    ...
    function xt(t) {
      ...
      if (!a[t] && r)
        try {
          (e = m.locale()), require("./locale/" + t), m.locale(e);
        } catch (t) {}
      return a[t];
    }
    function Dt(t, e) {
      return e._isUTC ? m(t).zone(e._offset || 0) : m(t).local();
    }
    function Mt(t, e) {
      return t.isValid()
        ? ((e = Ot(e, t.localeData())),
          B[e] ||
            (B[e] = (function (i) {
              ...
              return function (t) {
                var e = "";
                for (o = 0; o < s; o++)
                  e += a[o] instanceof Function ? a[o].call(t, i) : a[o];
                return e;
              };
            })(e)),
          B[e](t))
    ...
    function Ot(t, e) {
      ...
      for (k.lastIndex = 0; 0 <= i && k.test(t); )
        (t = t.replace(k, o)), (k.lastIndex = 0), (i -= 1);
      return t;
    }
    function It(t, e) {
      var i,
    ...
    function At(t, e, i) {
      ...
      switch (t) {
        ...
        case "MMM":
        case "MMMM":
          null != (o = i._locale.monthsParse(e))
            ? (s[l] = o)
            : (i._pf.invalidMonth = e);
          break;
        case "D":
        case "DD":
          null != e && (s[h] = bt(e));
          break;
        case "Do":
          null != e && (s[h] = bt(parseInt(e, 10)));
          break;
        case "DDD":
        case "DDDD":
          null != e && (i._dayOfYear = bt(e));
          break;
        case "YY":
          s[g] = m.parseTwoDigitYear(e);
          break;
        case "YYYY":
        case "YYYYY":
        case "YYYYYY":
        ...
        case "Z":
        case "ZZ":
          (i._useUTC = !0), (i._tzm = Lt(e));
          break;
        case "dd":
        case "ddd":
        case "dddd":
          null != (o = i._locale.weekdaysParse(e))
            ? ((i._w = i._w || {}), (i._w.d = o))
            : (i._pf.invalidWeekday = e);
          break;
        case "w":
        case "ww":
        case "W":
        ...
        case "GGGG":
        case "GGGGG":
          (t = t.substr(0, 2)), e && ((i._w = i._w || {}), (i._w[t] = bt(e)));
          break;
        case "gg":
        case "GG":
          (i._w = i._w || {}), (i._w[t] = m.parseTwoDigitYear(e));
      }
    }
    function Ft(t) {
      var e, i, o, s, a, n, r, l, d, c, h, p, u, f;
      null != (e = t._w).GG || null != e.W || null != e.E
        ? ((a = 1),
          (n = 4),
          (i = J(e.GG, t._a[g], Wt(m(), 1, 4).year)),
          (o = J(e.W, 1)),
          (s = J(e.E, 1)))
        : ((a = t._locale._week.dow),
          (n = t._locale._week.doy),
          (i = J(e.gg, t._a[g], Wt(m(), a, n).year)),
          (o = J(e.w, 1)),
          null != e.d ? (s = e.d) < a && ++o : (s = null != e.e ? e.e + a : a)),
        (d = o),
        (c = s),
        (h = n),
        (p = a),
        (f = Ht((l = i), 0, 1).getUTCDay()),
        (r = {
          year:
            0 <
            (u =
              7 * (d - 1) +
              ((c = null != c ? c : p) - p) +
              (p - (f = 0 === f ? 7 : f) + (h < f ? 7 : 0) - (f < p ? 7 : 0)) +
              1)
              ? l
              : l - 1,
          dayOfYear: 0 < u ? u : kt(l - 1) + u,
        }),
        (t._a[g] = r.year),
      ...
      if (!t._d) {
        ...
        for (
          n = t,
            ...
            t._w && null == t._a[h] && null == t._a[l] && Ft(t),
            t._dayOfYear &&
              ((s = J(t._a[g], o[g])),
              t._dayOfYear > kt(s) && (t._pf._overflowDayOfYear = !0),
              (i = Ht(s, 0, t._dayOfYear)),
              (t._a[l] = i.getUTCMonth()),
              (t._a[h] = i.getUTCDate())),
            e = 0;
          e < 3 && null == t._a[e];
          ++e
        ...
        (t._d = (
          t._useUTC
            ? Ht
            : function (t, e, i, o, s, a, n) {
                var r = new Date(t, e, i, o, s, a, n);
                t < 1970 && r.setFullYear(t);
                return r;
              }
        ).apply(null, a)),
    ...
    function Pt(t) {
      if (t._f !== m.ISO_8601) {
        ...
        var e,
          ...
          r = n.length,
          l = 0;
        for (o = Ot(t._f, t._locale).match(_) || [], e = 0; e < o.length; e++)
          (s = o[e]),
            (i = (n.match(It(s, t)) || [])[0]) &&
              (0 < (a = n.substr(0, n.indexOf(i))).length &&
                t._pf.unusedInput.push(a),
              (n = n.slice(n.indexOf(i) + i.length)),
              (l += i.length)),
            Q[s]
              ? (i ? (t._pf.empty = !1) : t._pf.unusedTokens.push(s),
                At(s, i, t))
              : t._strict && !i && t._pf.unusedTokens.push(s);
        (t._pf.charsLeftOver = r - l),
          0 < n.length && t._pf.unusedInput.push(n),
          t._isPm && t._a[p] < 12 && (t._a[p] += 12),
          !1 === t._isPm && 12 === t._a[p] && (t._a[p] = 0),
          Et(t),
          St(t);
      } else Yt(t);
    }
    function Yt(t) {
      var e,
        ...
        s = H.exec(o);
      if (s) {
        for (t._pf.iso = !0, e = 0, i = W.length; e < i; e++)
          if (W[e][1].exec(o)) {
            t._f = W[e][0] + (s[6] || " ");
            break;
          }
        for (e = 0, i = z.length; e < i; e++)
          if (z[e][1].exec(o)) {
            t._f += z[e][0];
            break;
          }
        o.match(M) && (t._f += "Z"), Pt(t);
      } else t._isValid = !1;
    }
    function Rt(t) {
      var e,
      ...
      n === d
        ...
        : ((a = n),
          ...
          a instanceof Date
            ...
            ? (Yt((s = t)),
              !1 === s._isValid &&
                (delete s._isValid, m.createFromInputFallback(s)))
            : ft(n)
            ? ((t._a = (function (t, e) {
                var i,
                  o = [];
    ...
    function Wt(t, e, i) {
      ...
      return (
        ...
        a < s - 7 && (a += 7),
        (o = m(t).add(a, "d")),
        { week: Math.ceil(o.dayOfYear() / 7), year: o.year() }
      );
    }
    function zt(t) {
      var e = t._i,
        i = t._f;
      return (
        (t._locale = t._locale || m.localeData(t._l)),
        null === e || (i === d && "" === e)
          ? m.invalid({ nullInput: !0 })
              ...
              : (i
                  ? ft(i)
                    ? (function (t) {
                        ...
                        if (0 === t._f.length)
                          return (
                            (t._pf.invalidFormat = !0), (t._d = new Date(NaN))
                          );
                        for (s = 0; s < t._f.length; s++)
                          (a = 0),
                            ...
                            Pt(e),
                            Ct(e) &&
                              ((a += e._pf.charsLeftOver),
                              (a += 10 * e._pf.unusedTokens.length),
                              (e._pf.score = a),
                              (null == o || a < o) && ((o = a), (i = e)));
                        rt(t, i || e);
                      })(t)
    ...
    function Nt(t, e) {
      var i, o;
      if ((1 === e.length && ft(e[0]) && (e = e[0]), !e.length)) return m();
    ...
    for (
      Q.DDDD = it(Q.DDD, 3),
        rt(st.prototype, {
            ...
            for (
              ...
              if (
                (this._monthsParse[e] ||
                  ...
                  (this._monthsParse[e] = new RegExp(o.replace(".", ""), "i"))),
          ...
          relativeTime: function (t, e, i, o) {
            var s = this._relativeTime[i];
            return "function" == typeof s ? s(t, e, i, o) : s.replace(/%d/i, t);
          },
          ...
          return (
            m.isDuration(t)
              ...
              : "object" == typeof d &&
                ...
                n.isBefore(r)
                  ? (l = ht(n, r))
                  : (((l = ht(r, n)).milliseconds = -l.milliseconds),
                    (l.months = -l.months)),
                ((d = {}).ms = (a = l).milliseconds),
                (d.M = a.months)),
            (o = new nt(d)),
            m.isDuration(t) && K(t, "_locale") && (o._locale = t._locale),
            o
          );
        },
        m.version = "2.8.3",
        ...
        m.ISO_8601 = function () {},
        m.momentProperties = n,
        m.updateOffset = function () {},
        m.relativeTimeThreshold = function (t, e) {
          return q[t] !== d && (e === d ? q[t] : ((q[t] = e), !0));
        },
        m.lang = et(
        ...
        m.locale = function (t, e) {
          ...
          return (
            t &&
              (i = void 0 !== e ? m.defineLocale(t, e) : m.localeData(t)) &&
              (m.duration._locale = m._locale = i),
            m._locale._abbr
          );
        },
        ...
        m.langData = et(
          ...
          function (t) {
            return m.localeData(t);
          }
        ),
        m.localeData = function (t) {
          var e;
          ...
          return (function (t) {
            for (var e, i, o, s, a = 0; a < t.length; ) {
              for (
                e = (s = $t(t[a]).split("-")).length,
                  i = (i = $t(t[a + 1])) ? i.split("-") : null;
                0 < e;

              ) {
                if ((o = xt(s.slice(0, e).join("-")))) return o;
                if (i && i.length >= e && mt(s, i, !0) >= e - 1) break;
                e--;
              }
              a++;
            }
        ...
        m.isMoment = function (t) {
          return t instanceof at || (null != t && K(t, "_isAMomentObject"));
        },
    ...
    function qt(e, i) {
      return function (t) {
        return null != t
          ? (Bt(this, e, t), m.updateOffset(this, i), this)
          : jt(this, e);
      };
    }
    function Gt(t) {
    ...
    function Qt(t) {
      m.duration.fn[t] = function () {
        return this._data[t];
      };
    }
    for (t in ((m.normalizeUnits = function (t) {
      return gt(t);
    }),
    (m.invalid = function (t) {
      var e = m.utc(NaN);
      return null != t ? rt(e._pf, t) : (e._pf.userInvalidated = !0), e;
    }),
    (m.parseZone = function () {
      return m.apply(null, arguments).parseZone();
    }),
    (m.parseTwoDigitYear = function (t) {
      return bt(t) + (68 < bt(t) ? 1900 : 2e3);
    }),
    rt((m.fn = at.prototype), {
      clone: function () {
        return m(this);
      },
      valueOf: function () {
      ...
      toISOString: function () {
        ...
        return 0 < t.year() && t.year() <= 9999
          ? Mt(t, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
          : Mt(t, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]");
      },
      toArray: function () {
        var t = this;
        return [
      ...
      isDSTShifted: function () {
        return (
          !!this._a &&
          this.isValid() &&
          0 < mt(this._a, (this._isUTC ? m.utc(this._a) : m(this._a)).toArray())
        );
      },
      ...
      format: function (t) {
        var e = Mt(this, t || m.defaultFormat);
      ...
      diff: function (t, e, i) {
        var o,
          ...
          a,
          n = Dt(t, this),
          r = 6e4 * (this.zone() - n.zone());
        return (
          "year" === (e = gt(e)) || "month" === e
            ? ((o = 432e5 * (this.daysInMonth() + n.daysInMonth())),
              (s = 12 * (this.year() - n.year()) + (this.month() - n.month())),
              (a =
                this - m(this).startOf("month") - (n - m(n).startOf("month"))),
              (s +=
                (a -=
                  6e4 *
                  (this.zone() -
                    m(this).startOf("month").zone() -
                    (n.zone() - m(n).startOf("month").zone()))) / o),
              "year" === e && (s /= 12))
            : ((o = this - n),
              (s =
                "second" === e
      ...
      calendar: function (t) {
        var e = Dt(t || m(), this).startOf("day"),
          i = this.diff(e, "days", !0),
          o =
            i < -6
              ? "sameElse"
              : i < -1
      ...
      isAfter: function (t, e) {
        return "millisecond" === (e = gt(void 0 !== e ? e : "millisecond"))
          ? +(t = m.isMoment(t) ? t : m(t)) < +this
          : +this.clone().startOf(e) > +m(t).startOf(e);
      },
      isBefore: function (t, e) {
        return "millisecond" === (e = gt(void 0 !== e ? e : "millisecond"))
          ? +this < +(t = m.isMoment(t) ? t : m(t))
          : +this.clone().startOf(e) < +m(t).startOf(e);
      },
      isSame: function (t, e) {
        return "millisecond" === (e = gt(e || "millisecond"))
          ? +this == +(t = m.isMoment(t) ? t : m(t))
          : +this.clone().startOf(e) == +Dt(t, this).startOf(e);
      },
      min: et(
        "moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",
        function (t) {
          return (t = m.apply(null, arguments)) < this ? this : t;
        }
      ),
      max: et(
        "moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",
        function (t) {
          return this < (t = m.apply(null, arguments)) ? this : t;
        }
      ),
      zone: function (t, e) {
        var i,
        ...
        return null == t
          ? this._isUTC
            ? o
            : this._dateTzOffset()
          : ("string" == typeof t && (t = Lt(t)),
            Math.abs(t) < 16 && (t *= 60),
            !this._isUTC && e && (i = this._dateTzOffset()),
            (this._offset = t),
            (this._isUTC = !0),
            null != i && this.subtract(i, "m"),
            o !== t &&
              (!e || this._changeInProgress
                ? ut(this, m.duration(o - t, "m"), 1, !1)
      ...
      hasAlignedHourOffset: function (t) {
        return (t = t ? m(t).zone() : 0), (this.zone() - t) % 60 == 0;
      },
      ...
      dayOfYear: function (t) {
        var e =
          u((m(this).startOf("day") - m(this).startOf("year")) / 864e5) + 1;
      ...
      set: function (t, e) {
        return "function" == typeof this[(t = gt(t))] && this[t](e), this;
      },
      locale: function (t) {
        var e;
        return t === d
          ? this._locale._abbr
          : (null != (e = m.localeData(t)) && (this._locale = e), this);
      },
      lang: et(
        "moment().lang() is deprecated. Use moment().localeData() instead.",
        function (t) {
          return t === d ? this.localeData() : this.locale(t);
        }
      ),
      localeData: function () {
        return this._locale;
    ...
    (m.fn.millisecond = m.fn.milliseconds = qt("Milliseconds", !1)),
    (m.fn.second = m.fn.seconds = qt("Seconds", !1)),
    (m.fn.minute = m.fn.minutes = qt("Minutes", !1)),
    (m.fn.hour = m.fn.hours = qt("Hours", !0)),
    (m.fn.date = qt("Date", !0)),
    (m.fn.dates = et(
      "dates accessor is deprecated. Use date instead.",
      qt("Date", !0)
    )),
    (m.fn.year = qt("FullYear", !0)),
    (m.fn.years = et(
    ...
    rt((m.duration.fn = nt.prototype), {
      ...
      humanize: function (t) {
        var e,
          ...
          p =
            ...
            (h[4] = o),
            function (t, e, i, o, s) {
              return s.relativeTime(e || 1, !!i, t, o);
            }.apply({}, h));
        return (
          t && (p = this.localeData().pastFuture(+this, p)),
          this.localeData().postformat(p)
        );
      },
      add: function (t, e) {
        var i = m.duration(t, e);
        return (
      ...
      get: function (t) {
        return this[(t = gt(t)).toLowerCase() + "s"]();
      },
      as: function (t) {
        var e, i;
        if ("month" === (t = gt(t)) || "year" === t)
          return (
            (e = this._days + this._milliseconds / 864e5),
            (i = this._months + 12 * Gt(e)),
            "month" === t ? i : i / 12
          );
        switch (((e = this._days + Vt(this._months / 12)), t)) {
          case "week":
    ...
    (m.duration.fn.toString = m.duration.fn.toISOString),
    e))
      K(e, t) && Qt(t.toLowerCase());
    function Zt(t) {
...
!(function (t) {
  ...
  (function (a) {
    ...
    (n.VERSION = "3.3.6"),
      ...
      (n.prototype.close = function (t) {
        ...
        t && t.preventDefault(),
          ...
          o.trigger((t = a.Event("close.bs.alert"))),
          t.isDefaultPrevented() ||
            (o.removeClass("in"),
            a.support.transition && o.hasClass("fade")
              ? o
    ...
    (a.fn.alert = function (i) {
      return this.each(function () {
        var t = a(this),
          e = t.data("bs.alert");
        e || t.data("bs.alert", (e = new n(this))),
          "string" == typeof i && e[i].call(t);
      });
    }),
      (a.fn.alert.Constructor = n),
      (a.fn.alert.noConflict = function () {
        return (a.fn.alert = t), this;
      }),
      a(document).on("click.bs.alert.data-api", e, n.prototype.close);
  })(jQuery),
  (function (a) {
    "use strict";
    var s = function (t, e) {
        ...
        .on(
          ...
          function (t) {
            ...
            e.hasClass("btn") || (e = e.closest(".btn")),
              i.call(e, "toggle"),
              a(t.target).is('input[type="radio"]') ||
                a(t.target).is('input[type="checkbox"]') ||
                t.preventDefault();
          }
        )
        .on(
  ...
  (function (h) {
    ...
    function n(s) {
      return this.each(function () {
        var t = h(this),
          ...
          i = h.extend({}, p.DEFAULTS, t.data(), "object" == typeof s && s),
    ...
    (p.VERSION = "3.3.6"),
      ...
      (p.prototype.slide = function (t, e) {
        ...
        var r = o[0],
          l = h.Event("slide.bs.carousel", { relatedTarget: r, direction: a });
        if ((this.$element.trigger(l), !l.isDefaultPrevented())) {
          if (
            ((this.sliding = !0), s && this.pause(), this.$indicators.length)
          ) {
            this.$indicators.find(".active").removeClass("active");
            var d = h(this.$indicators.children()[this.getItemIndex(o)]);
            d && d.addClass("active");
          }
      ...
      (r.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            var i = n.Event("show.bs.collapse");
            if ((this.$element.trigger(i), !i.isDefaultPrevented())) {
              ...
              if (!n.support.transition) return s.call(this);
              var a = n.camelCase(["scroll", o].join("-"));
              this.$element
                .one("bsTransitionEnd", n.proxy(s, this))
      ...
      (r.prototype.hide = function () {
        if (!this.transitioning && this.$element.hasClass("in")) {
          ...
          if ((this.$element.trigger(t), !t.isDefaultPrevented())) {
            ...
            this.$element[e](0)
              .one("bsTransitionEnd", n.proxy(i, this))
              .emulateTransitionEnd(r.TRANSITION_DURATION);
          }
        }
      }),
          ...
          e.hasClass("open") &&
            ((o &&
              ...
              o.isDefaultPrevented() ||
                ...
                e
                  .removeClass("open")
                  .trigger(n.Event("hidden.bs.dropdown", i)))));
        }));
    }
    (o.VERSION = "3.3.6"),
      (o.prototype.toggle = function (t) {
        ...
        if (!e.is(".disabled, :disabled")) {
          ...
          if ((a(), !o)) {
            ...
            if (
              (i.trigger((t = n.Event("show.bs.dropdown", s))),
              t.isDefaultPrevented())
            )
              return;
            e.trigger("focus").attr("aria-expanded", "true"),
              i.toggleClass("open").trigger(n.Event("shown.bs.dropdown", s));
          }
          return !1;
        }
      }),
  ...
  (function (a) {
    ...
    function r(o, s) {
      return this.each(function () {
        var t = a(this),
          e = t.data("bs.modal"),
          i = a.extend({}, n.DEFAULTS, t.data(), "object" == typeof o && o);
        e || t.data("bs.modal", (e = new n(this, i))),
      ...
      a(document).on(
        ...
        function (t) {
          var e = a(this),
            ...
            s = o.data("bs.modal")
              ? "toggle"
              : a.extend({ remote: !/#/.test(i) && i }, o.data(), e.data());
    ...
    (g.VERSION = "3.3.6"),
      ...
      (g.prototype.init = function (t, e, i) {
        ...
        for (var o = this.options.trigger.split(" "), s = o.length; s--; ) {
          ...
          if ("click" == a)
            ...
            var n = "hover" == a ? "mouseenter" : "focusin",
      ...
      (g.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          var u = this.getCalculatedOffset(a, l, d, c);
      ...
      (g.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
        ...
        if (/right|left/.test(t)) {
          var r = e.top - a - n.scroll,
            l = e.top + a - n.scroll + o;
          r < n.top
            ? (s.top = n.top - r)
            : l > n.top + n.height && (s.top = n.top + n.height - l);
        } else {
          var d = e.left - a,
            c = e.left + a + i;
          d < n.left
            ? (s.left = n.left - d)
            : c > n.right && (s.left = n.left + n.width - c);
        }
        return s;
      }),
  ...
  (function (s) {
    ...
    (a.VERSION = "3.3.6"),
      ...
      (a.prototype = s.extend({}, s.fn.tooltip.Constructor.prototype)),
      ((a.prototype.constructor = a).prototype.getDefaults = function () {
        return a.DEFAULTS;
      }),
    ...
    (s.fn.popover = function (o) {
      return this.each(function () {
        var t = s(this),
          ...
          i = "object" == typeof o && o;
        (!e && /destroy|hide/.test(o)) ||
          (e || t.data("bs.popover", (e = new a(this, i))),
          "string" == typeof o && e[o]());
      });
    }),
    ...
    (s.VERSION = "3.3.6"),
      ...
      (s.prototype.refresh = function () {
        ...
        (this.offsets = []),
          ...
          a.isWindow(this.$scrollElement[0]) ||
            ((o = "position"), (s = this.$scrollElement.scrollTop())),
          this.$body
            .find(this.selector)
            .map(function () {
              var t = a(this),
                ...
                i = /^#./.test(e) && a(e);
              return (
                (i && i.length && i.is(":visible") && [[i[o]().top + s, e]]) ||
                null
              );
            })
            .sort(function (t, e) {
      ...
      (s.prototype.process = function () {
        ...
        if ((this.scrollHeight != i && this.refresh(), o <= e))
          return n != (t = a[a.length - 1]) && this.activate(t);
      ...
      (s.prototype.activate = function (t) {
        ...
        var e =
            ...
            t +
            '"]',
          i = a(e).parents("li").addClass("active");
      ...
      (n.prototype.show = function () {
        ...
        if (
          ...
          var o = e.find(".active:last a"),
            s = r.Event("hide.bs.tab", { relatedTarget: t[0] }),
            a = r.Event("show.bs.tab", { relatedTarget: o[0] });
          if (
            (o.trigger(s),
            t.trigger(a),
    ...
    (d.VERSION = "3.3.6"),
      ...
      (d.prototype.getState = function (t, e, i, o) {
        ...
        if ("bottom" == this.affixed)
          return null != i
            ? !(s + this.unpin <= a.top) && "bottom"
            : !(s + n <= t - o) && "bottom";
        var r = null == this.affixed,
          l = r ? s : a.top;
        return null != i && s <= i
          ? "top"
          : null != o && t - o <= l + (r ? n : e) && "bottom";
      }),
    ...
    (l = jQuery),
      ((i = function (t, e) {
        ...
        return (
          ...
          this.modal
            ...
            .on(
              ...
              function () {
                return (
                  s.gallery && l(document).off("keydown.ekkoLightbox"),
                  s.modal.remove(),
            ...
            ? ((this.gallery = this.$element.data("gallery")),
              this.gallery &&
                ...
                "" === this.options.gallery_parent_selector
                  ? (this.gallery_items = l(document.body).find(
                ...
                this.options.directional_arrows &&
                  ...
                  this.lightbox_container
                    ...
                    .on(
                      ...
                      ((i = this),
                      function (t) {
                        return t.preventDefault(), i.navigate_left();
                      })
                    ),
                  this.lightbox_container
                    .find(
              ...
              this.options.type
                ? "image" === this.options.type
                  ...
                  : "youtube" === this.options.type &&
                    (t = this.getYoutubeId(this.options.remote))
        ...
        navigateTo: function (t) {
          var e, i;
          return t < 0 || t > this.gallery_items.length - 1
            ? this
            : (this.showLoading(),
              (this.gallery_index = t),
              (this.$element = l(this.gallery_items.get(this.gallery_index))),
              ...
              ((i =
                (e = l(
                  ...
                  !1
                )).attr("data-remote") || e.attr("href")),
              "image" === e.attr("data-type") || this.isImage(i))
            ...
            (null == e || !0 === e) &&
              ((i.onload =
                ...
                function () {
                  var t;
                  return (
                    (t = l("<img />")).attr("src", i.src),
                    t.addClass("img-responsive"),
                    s.lightbox_body.html(t),
                    s.modal_arrows && s.modal_arrows.css("display", "block"),
                    t.load(function () {
                      return (
                        s.options.scale_height
                          ? s.scaleHeight(i.height, i.width)
                          : s.resize(i.width),
              ...
              (i.onerror =
                ((o = this),
                function () {
                  return o.error("Failed to load image: " + t);
                }))),
            (i.src = t),
            i
          );
        ...
        scaleHeight: function (t, e) {
          var i, o, s, a, n, r;
          return (
            (a = this.modal_header.outerHeight(!0) || 0),
            (s = this.modal_footer.outerHeight(!0) || 0),
            this.modal_footer.is(":visible") || (s = 0),
            this.modal_header.is(":visible") || (a = 0),
            (i =
              this.border.top +
              this.border.bottom +
              this.padding.top +
        ...
        resize: function (t) {
          ...
          return (
            (e =
              ...
              this.padding.right +
              this.border.right),
            this.modal_dialog.css("width", "auto").css("max-width", e),
            this.lightbox_container.find("a").css("line-height", function () {
              return l(this).parent().height() + "px";
            }),
            this
          );
        },
        checkDimensions: function (t) {
          ...
          return (
            (e =
              ...
              this.padding.right +
              this.border.right),
            document.body.clientWidth < e && (t = this.modal_body.width()),
            t
          );
        },
        close: function () {
    ...
    (s = 0),
      ((n = function (t, e) {
        ...
        (o.defaults = {
          ...
          (o.windowTimer = null),
          (i = d(t).data("slick") || {}),
          (o.options = d.extend({}, o.defaults, e, i)),
          ...
          for (
            ...
            for (e = 0; e < r.options.rows; e++) {
              ...
              for (i = 0; i < r.options.slidesPerRow; i++) {
                var c = t * n + (e * r.options.slidesPerRow + i);
      ...
      (n.prototype.lazyLoad = function () {
        ...
        !0 === o.options.centerMode
          ...
          : ((t = o.options.infinite
              ...
              : o.currentSlide),
            (e = Math.ceil(t + o.options.slidesToShow)),
            !0 === o.options.fade && (0 < t && t--, e <= o.slideCount && e++)),
          i(o.$slider.find(".slick-slide").slice(t, e)),
        ...
        (i = a.$slider
          ...
          !0 === a.options.centerMode
            ? ((e = Math.floor(a.options.slidesToShow / 2)),
              !0 === a.options.infinite &&
                ...
                0 === t
                  ...
                  : t === a.slideCount - 1 &&
                    i.eq(a.options.slidesToShow).addClass("slick-center")),
            ...
            : ((s = a.slideCount % a.options.slidesToShow),
              (o = !0 === a.options.infinite ? a.options.slidesToShow + t : t),
              a.options.slidesToShow == a.options.slidesToScroll &&
              a.slideCount - t < a.options.slidesToShow
                ? i
      ...
      (n.prototype.selectHandler = function (t) {
        var e = this,
          i = d(t.target).is(".slick-slide")
            ? d(t.target)
            : d(t.target).parents(".slick-slide"),
          o = parseInt(i.attr("data-slick-index"));
        if ((o || (o = 0), e.slideCount <= e.options.slidesToShow))
          return e.setSlideClasses(o), void e.asNavFor(o);
        e.slideHandler(o);
      }),
      ...
      (n.prototype.swipeMove = function (t) {
        ...
        return (
          ...
          !(!n.dragging || (a && 1 !== a.length)) &&
            ...
            (n.touchObject.curX = void 0 !== a ? a[0].pageX : t.clientX),
            (n.touchObject.curY = void 0 !== a ? a[0].pageY : t.clientY),
            ...
            "vertical" !== (i = n.swipeDirection())
              ? (void 0 !== t.originalEvent &&
                ...
                !0 === n.options.verticalSwiping &&
                  (s = n.touchObject.curY > n.touchObject.startY ? 1 : -1),
                (o = n.touchObject.swipeLength),
                (n.touchObject.edgeHit = !1) === n.options.infinite &&
                  ((0 === n.currentSlide && "right" === i) ||
                    (n.currentSlide >= n.getDotCount() && "left" === i)) &&
                  ((o = n.touchObject.swipeLength * n.options.edgeFriction),
                  (n.touchObject.edgeHit = !0)),
                !1 === n.options.vertical
                  ? (n.swipeLeft = e + o * s)
                  : (n.swipeLeft =
                      e + o * (n.$list.height() / n.listWidth) * s),
